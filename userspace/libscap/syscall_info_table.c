...
const struct ppm_syscall_desc g_syscall_info_table[PPM_SC_MAX] = {
	...
	/*PPM_SC_READ*/ { EC_IO_READ, (enum ppm_event_flags)(EF_NONE), "read" },
	/*PPM_SC_WRITE*/ { EC_IO_WRITE, (enum ppm_event_flags)(EF_NONE), "write" },
	/*PPM_SC_OPEN*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "open" },
	/*PPM_SC_CLOSE*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "close" },
	...
	/*PPM_SC_STAT*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "stat" },
	/*PPM_SC_LSEEK*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "lseek" },
	...
	/*PPM_SC_FSTAT*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "fstat" },
	...
	/*PPM_SC_FCNTL*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "fcntl" },
	...
	/*PPM_SC_GETTIMEOFDAY*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "gettimeofday" },
	/*PPM_SC_SETTIMEOFDAY*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "settimeofday" },
	/*PPM_SC_SYMLINK*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "symlink" },
	/*PPM_SC_LSTAT*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "lstat" },
	...
	/*PPM_SC_MMAP*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "mmap" },
	/*PPM_SC_MUNMAP*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "munmap" },
	...
	/*PPM_SC_STATFS*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "statfs" }, /* returns information about a mounted file system */
	/*PPM_SC_FSTATFS*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "fstatfs" }, /* returns information about a mounted file system */
	...
	/*PPM_SC_SETITIMER*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "setitimer" },
	/*PPM_SC_GETITIMER*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "getitimer" },
	...
	/*PPM_SC_WAIT4*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "wait4" }, /* OBSOLETE */
	...
	/*PPM_SC_SELECT*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "select" },
	...
	/*PPM_SC_READV*/ { EC_IO_READ, (enum ppm_event_flags)(EF_NONE), "readv" },
	/*PPM_SC_WRITEV*/ { EC_IO_WRITE, (enum ppm_event_flags)(EF_NONE), "writev" },
	...
	/*PPM_SC_SCHED_YIELD*/ { EC_SLEEP, (enum ppm_event_flags)(EF_NONE), "sched_yield" },
	...
	/*PPM_SC_POLL*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "poll" },
	...
	/*PPM_SC_SENDFILE*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "sendfile" }, /* transfer data between file descriptors */
	...
	/*PPM_SC_FUTEX*/ { EC_IPC, (enum ppm_event_flags)(EF_NONE), "futex" },
	...
	/*PPM_SC_EPOLL_CREATE*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "epoll_create" },
	/*PPM_SC_EPOLL_CTL*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "epoll_ctl" },
	/*PPM_SC_EPOLL_WAIT*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "epoll_wait" },
	...
	/*PPM_SC_TIMER_CREATE*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "timer_create" },
	/*PPM_SC_TIMER_SETTIME*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "timer_settime" },
	/*PPM_SC_TIMER_GETTIME*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "timer_gettime" },
	/*PPM_SC_TIMER_GETOVERRUN*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "timer_getoverrun" },
	/*PPM_SC_TIMER_DELETE*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "timer_delete" },
	/*PPM_SC_CLOCK_SETTIME*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "clock_settime" },
	/*PPM_SC_CLOCK_GETTIME*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "clock_gettime" },
	/*PPM_SC_CLOCK_GETRES*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "clock_getres" },
	/*PPM_SC_CLOCK_NANOSLEEP*/ { EC_SLEEP, (enum ppm_event_flags)(EF_NONE), "clock_nanosleep" },
	...
	/*PPM_SC_IOPRIO_SET*/ { EC_PROCESS, (enum ppm_event_flags)(EF_NONE), "ioprio_set" }, /* get/set I/O scheduling class and priority */
	/*PPM_SC_IOPRIO_GET*/ { EC_PROCESS, (enum ppm_event_flags)(EF_NONE), "ioprio_get" }, /* get/set I/O scheduling class and priority */
	...
	/*PPM_SC_PSELECT6*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "pselect6" },
	/*PPM_SC_PPOLL*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "ppoll" },
	...
	/*PPM_SC_SPLICE*/ { EC_IPC, (enum ppm_event_flags)(EF_NONE), "splice" }, /* transfers up to len bytes of data from the file descriptor fd_in to the file descriptor fd_out, where one of the descriptors must refer to a pipe. */
	/*PPM_SC_TEE*/ { EC_IPC, (enum ppm_event_flags)(EF_NONE), "tee" }, /* tee() duplicates up to len bytes of data from the pipe referred to by the file descriptor fd_in to the pipe referred to by the file descriptor fd_out. It does not consume the data that is duplicated from fd_in. */
	...
	/*PPM_SC_EPOLL_PWAIT*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "epoll_pwait" },
	...
	/*PPM_SC_TIMERFD_CREATE*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "timerfd_create" }, /* // create and operate on a timer that delivers timer expiration notifications via a file descriptor */
	/*PPM_SC_EVENTFD*/ { EC_IPC, (enum ppm_event_flags)(EF_NONE), "eventfd" }, /* create a file descriptor for event notification */
	/*PPM_SC_TIMERFD_SETTIME*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "timerfd_settime" }, /* create and operate on a timer that delivers timer expiration notifications via a file descriptor */
	/*PPM_SC_TIMERFD_GETTIME*/ { EC_TIME, (enum ppm_event_flags)(EF_NONE), "timerfd_gettime" }, /* create and operate on a timer that delivers timer expiration notifications via a file descriptor */
	...
	/*PPM_SC_EPOLL_CREATE1*/ { EC_WAIT, (enum ppm_event_flags)(EF_NONE), "epoll_create1" }, /* variant of epoll_create */
	...
	/*PPM_SC_PREADV*/ { EC_IO_READ, (enum ppm_event_flags)(EF_NONE), "preadv" },
	/*PPM_SC_PWRITEV*/ { EC_IO_WRITE, (enum ppm_event_flags)(EF_NONE), "pwritev" },
	...
	/*PPM_SC_SHUTDOWN*/  { EC_NET, (enum ppm_event_flags)(EF_NONE), "shutdown" },
	...
	/*PPM_SC_SENDMMSG*/  { EC_NET, (enum ppm_event_flags)(EF_NONE), "sendmmsg" },
	/*PPM_SC_RECVMSG*/  { EC_NET, (enum ppm_event_flags)(EF_NONE), "recvmsg" },
	/*PPM_SC_RECVMMSG*/  { EC_NET, (enum ppm_event_flags)(EF_NONE), "recvmmsg" },
	...
	/*PPM_SC_STATFS64*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "statfs64" },
	/*PPM_SC_FSTATFS64*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "fstatfs64" },
	/*PPM_SC_FSTATAT64*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "fstatat64" },
	/*PPM_SC_SENDFILE64*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "sendfile64" },
	...
	/*PPM_SC_STAT64*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "stat64" },
	/*PPM_SC_LSTAT64*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "lstat64" },
	/*PPM_SC_FSTAT64*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "fstat64" },
	/*PPM_SC_FCNTL64*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "fcntl64" },
	/*PPM_SC_MMAP2*/ { EC_FILE, (enum ppm_event_flags)(EF_NONE), "mmap2" },
	...
	/*PPM_SC_FSCONFIG*/ {EC_SYSTEM, (enum ppm_event_flags)(EF_NONE), "fsconfig"},
};
