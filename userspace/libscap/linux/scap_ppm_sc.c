...
static const ppm_sc_code *g_events_to_sc_map[] = {
	...
	[PPME_SOCKET_ACCEPT4_E] = (ppm_sc_code[]){PPM_SC_ACCEPT, -1},
	[PPME_SOCKET_ACCEPT4_X] = (ppm_sc_code[]){PPM_SC_ACCEPT, -1},
	...
	[PPME_SYSCALL_LSTAT64_E] = (ppm_sc_code[]){PPM_SC_UNKNOWN, -1}, // lstat64 -> is not impl by supported archs
	[PPME_SYSCALL_LSTAT64_X] = (ppm_sc_code[]){PPM_SC_UNKNOWN, -1}, // lstat64 -> is not impl by supported archs
