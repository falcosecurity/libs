...
public:
	...
	static ss_plugin_table_field_t* get_field(ss_plugin_table_t* _t,
	                                          const char* name,
	...
	static ss_plugin_table_entry_t* get_entry(ss_plugin_table_t* _t,
	...
	static ss_plugin_rc read_entry_field(ss_plugin_table_t* _t,
	...
	static ss_plugin_bool iterate_entries(ss_plugin_table_t* _t,
	...
	static ss_plugin_table_entry_t* add_entry(ss_plugin_table_t* _t,
	                                          const ss_plugin_state_data* key,
	                                          ss_plugin_table_entry_t* _e) {
		auto t = static_cast<sample_table*>(_t);
		auto e = static_cast<sample_table::entry*>(_e);
