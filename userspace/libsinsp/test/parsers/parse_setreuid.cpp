...
TEST_F(sinsp_with_test_input, SETREUID_failure)
{
	...
	add_event_advance_ts(increasing_ts(), p2_t2_tid, PPME_SYSCALL_SETREUID_X, 3, (uint64_t)1, (uint32_t)0, (uint32_t)0);
...
TEST_F(sinsp_with_test_input, SETREUID_success)
{
	...
	add_event_advance_ts(increasing_ts(), p2_t2_tid, PPME_SYSCALL_SETREUID_X, 3, (uint64_t)0, (uint32_t)1337, (uint32_t)1337);
