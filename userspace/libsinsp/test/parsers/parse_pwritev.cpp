...
TEST_F(sinsp_with_test_input, PWRITEV_success) {
	...
	constexpr sinsp_test_input::open_params opn_params = {};  // Use default values.
	...
	auto fdinfo_tinfo = init_tinfo->get_fd(opn_params.fd);
