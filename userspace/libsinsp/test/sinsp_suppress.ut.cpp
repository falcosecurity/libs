...
INSTANTIATE_TEST_CASE_P(
        suppressed_comm_tests,
        suppressed_comm_test,
        ::testing::ValuesIn(std::vector<test_case>{
                {.name = "single suppressed comm",
                 .suppressed_comms = {"suppress_me"},
                 .entries =
                         {
                                 {1, 0, "systemd"},
                                 {2, 1, "suppress_me"},
                 ...
                 .expected_suppressed_tids = {2}},
                {.name = "multiple suppressed comms",
                 .suppressed_comms = {"suppress_me", "ignore_me"},
                 .entries =
                         {
                                 {1, 0, "systemd"},
                                 {2, 1, "suppress_me"},
                 ...
                 .expected_suppressed_tids = {2, 3}},
                {.name = "hierarchical suppressed comms",
                 .suppressed_comms = {"suppress_me"},
                 .entries =
                         {
                                 {1, 0, "systemd"},
                 ...
                 .expected_suppressed_tids = {2, 3}},
                {.name = "out of order hierarchical suppressed comms",
                 .suppressed_comms = {"suppress_me"},
                 .entries =
                         {
                                 {1, 0, "systemd"},
                 ...
                 .expected_suppressed_tids = {3, 2}},
                {.name = "child of o child of a suppressed",
                 .suppressed_comms = {"suppress_me", "destroy_me"},
                 .entries = {{1, 0, "systemd"},
                             ...
                             {1010, 1, "im_fine"}},
                 .expected_suppressed_tids = {100, 200, 1000, 2000, 10, 20}},
        }),
