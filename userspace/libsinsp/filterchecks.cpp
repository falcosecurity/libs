...
const filtercheck_field_info sinsp_filter_check_gen_event_fields[] =
{
	...
	{PT_ABSTIME, EPF_NONE, PF_DEC, "evt.rawtime", "Absoltue Time", "absolute event timestamp, i.e. nanoseconds from epoch."},
	{PT_ABSTIME, EPF_NONE, PF_DEC, "evt.rawtime.s", "Absoltue Time (s)", "integer part of the event timestamp (e.g. seconds since epoch)."},
	{PT_ABSTIME, EPF_NONE, PF_10_PADDED_DEC, "evt.rawtime.ns", "Absoltue Time (ns)", "fractional part of the absolute event timestamp."},
...
const filtercheck_field_info sinsp_filter_check_event_fields[] =
{
	...
	{PT_BOOL, EPF_NONE, PF_NA, "evt.is_open_write", "Is Openend For Writing", "'true' for open/openat/openat2 events where the path was opened for writing"},
