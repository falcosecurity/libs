...
{
	m_info.m_name = "k8s";
	m_info.m_desc = "Kubernetes related context. Available with all fields only when configured to fetch from the K8s API Server. Otherwise, only `k8s.pod.*` fields are populated.";
