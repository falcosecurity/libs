...
public:
	 ...
	 * system-available CPUs. `disable_iterators` disables the BPF iterator support for synchronous
	 * information fetching, letting scap falling back to the procfs lookups.
	 */
