...
public:
	...
	*/
	...
	const libsinsp::state::accessor::typed_ptr<std::string>* get_field_accessor(
...
private:
	...
	std::atomic<uint64_t> m_n_get_thread_proc_adds{0};
	std::atomic<uint64_t> m_n_get_thread_fake_adds{0};
