...
libsinsp::state::static_struct::field_infos sinsp_fdinfo::static_fields() const {
	...
	define_static_field<uint8_t>(ret, OFFSETOF(T, m_type) + type_byte_offset, "type");

	// the rest fo the fields are more trivial to expose
	DEFINE_STATIC_FIELD(ret, T, m_openflags, "open_flags");
	DEFINE_STATIC_FIELD(ret, T, m_name, "name");
	DEFINE_STATIC_FIELD(ret, T, m_name_raw, "name_raw");
	DEFINE_STATIC_FIELD(ret, T, m_oldname, "old_name");
	DEFINE_STATIC_FIELD(ret, T, m_flags, "flags");
	DEFINE_STATIC_FIELD(ret, T, m_dev, "dev");
	DEFINE_STATIC_FIELD(ret, T, m_mount_id, "mount_id");
	DEFINE_STATIC_FIELD(ret, T, m_ino, "ino");
	DEFINE_STATIC_FIELD(ret, T, m_pid, "pid");
	DEFINE_STATIC_FIELD(ret, T, m_fd, "fd");
	...
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv4info.m_fields.m_sip, "socket_ipv4_src_ip");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv4info.m_fields.m_dip, "socket_ipv4_dest_dip");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv4info.m_fields.m_sport, "socket_ipv4_src_port");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv4info.m_fields.m_dport, "socket_ipv4_dst_port");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv4info.m_fields.m_l4proto, "socket_ipv4_l4_proto");
	define_static_field<uint64_t>(ret,
	                              OFFSETOF(T, m_sockinfo.m_ipv6info.m_fields.m_sip),
	                              "socket_ipv6_src_ip_low");
	define_static_field<uint64_t>(ret,
	                              OFFSETOF(T, m_sockinfo.m_ipv6info.m_fields.m_sip) + 8,
	                              "socket_ipv6_src_ip_high");
	define_static_field<uint64_t>(ret,
	                              OFFSETOF(T, m_sockinfo.m_ipv6info.m_fields.m_dip),
	                              "socket_ipv6_dest_ip_low");
	define_static_field<uint64_t>(ret,
	                              OFFSETOF(T, m_sockinfo.m_ipv6info.m_fields.m_dip) + 8,
	                              "socket_ipv6_dest_ip_high");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv6info.m_fields.m_sport, "socket_ipv6_src_port");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv6info.m_fields.m_dport, "socket_ipv6_dst_port");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv6info.m_fields.m_l4proto, "socket_ipv6_l4_proto");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv4serverinfo.m_ip, "socket_ipv4_server_ip");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv4serverinfo.m_port, "socket_ipv4_server_port");
	DEFINE_STATIC_FIELD(ret,
	                    T,
	                    m_sockinfo.m_ipv4serverinfo.m_l4proto,
	                    "socket_ipv4_server_l4_proto");
	define_static_field<uint64_t>(ret,
	                              OFFSETOF(T, m_sockinfo.m_ipv6serverinfo.m_ip),
	                              "socket_ipv6_server_ip_low");
	define_static_field<uint64_t>(ret,
	                              OFFSETOF(T, m_sockinfo.m_ipv6serverinfo.m_ip) + 8,
	                              "socket_ipv6_server_ip_high");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_ipv6serverinfo.m_port, "socket_ipv6_server_port");
	DEFINE_STATIC_FIELD(ret,
	                    T,
	                    m_sockinfo.m_ipv6serverinfo.m_l4proto,
	                    "socket_ipv6_server_l4_proto");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_unixinfo.m_fields.m_source, "socket_unix_src");
	DEFINE_STATIC_FIELD(ret, T, m_sockinfo.m_unixinfo.m_fields.m_dest, "socket_unix_dest");
