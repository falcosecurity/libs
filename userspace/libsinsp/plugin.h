...
template<>
inline void wrap_state_data<libsinsp::state::base_table*>(
...
template<>
inline void unwrap_state_data<uint16_t>(const ss_plugin_state_data& val,
                                                     uint16_t& out) {
	out = val.u16;
}

template<>
inline void unwrap_state_data<uint32_t>(const ss_plugin_state_data& val,
                                                     uint32_t& out) {
	out = val.u32;
}

template<>
inline void unwrap_state_data<uint64_t>(const ss_plugin_state_data& val,
                                                     uint64_t& out) {
	out = val.u64;
}

template<>
inline void unwrap_state_data<std::string>(const ss_plugin_state_data& val,
                                                        std::string& out) {
	out = val.str;
}
