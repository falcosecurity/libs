...
#define TABLE_ADAPTER_TABLE_OFFSET(table_adapter_type) \
	reinterpret_cast<size_t>(                          \
	        static_cast<libsinsp::state::base_table*>(static_cast<table_adapter_type*>(0)))
	...
	DEFINE_STATIC_FIELD(ret, T, m_pid, "tid");
	DEFINE_STATIC_FIELD(ret, T, m_pid, "pid");
	DEFINE_STATIC_FIELD(ret, T, m_ptid, "ptid");
	DEFINE_STATIC_FIELD(ret, T, m_reaper_tid, "reaper_tid");
	DEFINE_STATIC_FIELD(ret, T, m_sid, "sid");
	DEFINE_STATIC_FIELD(ret, T, m_comm, "comm");
	DEFINE_STATIC_FIELD(ret, T, m_exe, "exe");
	DEFINE_STATIC_FIELD(ret, T, m_exepath, "exe_path");
	DEFINE_STATIC_FIELD(ret, T, m_exe_writable, "exe_writable");
	DEFINE_STATIC_FIELD(ret, T, m_exe_upper_layer, "exe_upper_layer");
	DEFINE_STATIC_FIELD(ret, T, m_exe_lower_layer, "exe_lower_layer");
	DEFINE_STATIC_FIELD(ret, T, m_exe_from_memfd, "exe_from_memfd");
	define_static_field<libsinsp::state::base_table*>(
	        ret,
	        OFFSETOF(T, m_args_table_adapter) +
	                TABLE_ADAPTER_TABLE_OFFSET(decltype(m_args_table_adapter)),
	        "args",
	        true);
	define_static_field<libsinsp::state::base_table*>(
	        ret,
	        OFFSETOF(T, m_env_table_adapter) +
	                TABLE_ADAPTER_TABLE_OFFSET(decltype(m_env_table_adapter)),
	        "env",
	        true);
	define_static_field<libsinsp::state::base_table*>(
	        ret,
	        OFFSETOF(T, m_cgroups_table_adapter) +
	                TABLE_ADAPTER_TABLE_OFFSET(decltype(m_cgroups_table_adapter)),
	        "cgroups",
	        true);
	DEFINE_STATIC_FIELD(ret, T, m_flags, "flags");
	DEFINE_STATIC_FIELD(ret, T, m_fdlimit, "fd_limit");
	DEFINE_STATIC_FIELD(ret, T, m_uid, "uid");
	DEFINE_STATIC_FIELD(ret, T, m_gid, "gid");
	DEFINE_STATIC_FIELD(ret, T, m_loginuid, "loginuid");
	// m_cap_permitted
	// m_cap_effective
	// m_cap_inheritable
	DEFINE_STATIC_FIELD(ret, T, m_exe_ino, "exe_ino");
	DEFINE_STATIC_FIELD(ret, T, m_exe_ino_ctime, "exe_ino_ctime");
	DEFINE_STATIC_FIELD(ret, T, m_exe_ino_mtime, "exe_ino_mtime");
	...
	// m_pfmajor
	// m_pfminor
	DEFINE_STATIC_FIELD(ret, T, m_vtid, "vtid");
	DEFINE_STATIC_FIELD(ret, T, m_vpid, "vpid");
	DEFINE_STATIC_FIELD(ret, T, m_vpgid, "vpgid");
	DEFINE_STATIC_FIELD(ret, T, m_pgid, "pgid");
	DEFINE_STATIC_FIELD(ret, T, m_pidns_init_start_ts, "pidns_init_start_ts");
	DEFINE_STATIC_FIELD(ret, T, m_root, "root");
	DEFINE_STATIC_FIELD(ret, T, m_tty, "tty");
	// m_category
	// m_clone_ts
	// m_lastexec_ts
	// m_latency
	DEFINE_STATIC_FIELD_READONLY(ret, T, m_main_fdtable, "file_descriptors", true);
	DEFINE_STATIC_FIELD_READONLY(ret, T, m_cwd, "cwd", true);
