...
sinsp::sinsp(bool with_metrics):
        ...
        m_thread_manager_dyn_fields{
                std::make_shared<libsinsp::state::dynamic_struct<sinsp_threadinfo>::dynamic_field_infos>()},
        m_fdtable_dyn_fields{
                std::make_shared<libsinsp::state::dynamic_struct<sinsp_fdinfo>::dynamic_field_infos>()},
