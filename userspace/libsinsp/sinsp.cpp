...
sinsp::sinsp(bool with_metrics):
        ...
        m_fdtable_factory{m_mode,
                          ...
                          m_sinsp_stats_v2,
                          m_platform},
        // After m_threadinfo_ctor_params initialization, the thread manager, usergroup manager and
        // filter fields will refer to non-initialized sinsp's fields. This is not a problem as long
