...
bool sinsp_filter_check_thread::compare_full_apid(sinsp_evt* evt) {
	...
	sinsp_thread_manager::visitor_func_t visitor = [this, &found](sinsp_threadinfo* pt) {
		auto pid = pt->get_pid();
		bool res = compare_rhs(m_cmp, PT_PID, &pid);
...
bool sinsp_filter_check_thread::compare_full_aname(sinsp_evt* evt) {
	...
	sinsp_thread_manager::visitor_func_t visitor = [this, &found](sinsp_threadinfo* pt) {
		auto comm = pt->get_comm();
		bool res = compare_rhs(m_cmp, PT_CHARBUF, (void*)comm.c_str());
...
bool sinsp_filter_check_thread::compare_full_aexe(sinsp_evt* evt) {
	...
	sinsp_thread_manager::visitor_func_t visitor = [this, &found](sinsp_threadinfo* pt) {
		auto exe = pt->get_exe();
		bool res = compare_rhs(m_cmp, PT_CHARBUF, (void*)exe.c_str());
...
bool sinsp_filter_check_thread::compare_full_aexepath(sinsp_evt* evt) {
	...
	sinsp_thread_manager::visitor_func_t visitor = [this, &found](sinsp_threadinfo* pt) {
		...
		bool res = compare_rhs(m_cmp, PT_CHARBUF, (void*)exepath.c_str());
