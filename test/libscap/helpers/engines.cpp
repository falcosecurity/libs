...
void check_event_order(scap_t *h) {
	uint32_t events_to_assert[EVENTS_TO_ASSERT] = {
	        ...
	        PPME_SYSCALL_GETGID_E,   PPME_SYSCALL_GETGID_X,   PPME_SYSCALL_GETEUID_X,
	        PPME_SYSCALL_GETUID_E,   PPME_SYSCALL_GETUID_X,   PPME_SOCKET_BIND_E,
