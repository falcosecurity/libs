...
TEST_F(convert_event_test, PPME_SYSCALL_FCNTL_X_to_4_params_no_enter) {
	constexpr uint64_t ts = 12;
	constexpr int64_t tid = 25;
...
TEST_F(convert_event_test, PPME_SYSCALL_FCNTL_X_to_4_params_with_enter) {
	constexpr uint64_t ts = 12;
	constexpr int64_t tid = 25;
...
TEST_F(convert_event_test, PPME_SYSCALL_EXECVE_19_X_18_to_31_params_with_enter) {
	...
	// After the first conversion we should have the storage.
	const auto evt = create_safe_scap_event(ts, tid_hdr, PPME_SYSCALL_EXECVE_19_E, 1, filename);
	assert_single_conversion_pass(evt);
	assert_event_storage_presence(evt);
...
TEST_F(convert_event_test, PPME_SOCKET_SOCKET_X_to_5_params_no_enter) {
	...
	assert_full_conversion(create_safe_scap_event(ts, tid, PPME_SOCKET_SOCKET_X, 1, fd),
	                       create_safe_scap_event(ts,
	                                              tid,
