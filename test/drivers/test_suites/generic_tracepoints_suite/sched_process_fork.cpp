...
TEST(GenericTracepoints, sched_proc_fork_case_clone3_create_child_with_3_threads)
{
	auto evt_test = get_syscall_event_test(__NR_clone, EXIT_EVENT);
...
TEST(GenericTracepoints, sched_proc_fork_case_clone3_create_child_process_from_a_child_thread)
{
	auto evt_test = get_syscall_event_test(__NR_clone, EXIT_EVENT);
...
TEST(GenericTracepoints, sched_proc_fork_case_clone3_child_new_namespace)
{
	auto evt_test = get_syscall_event_test(__NR_clone, EXIT_EVENT);
...
TEST(GenericTracepoints, sched_proc_fork_case_clone3_child_new_namespace_create_thread)
{
	...
	/* Parameter 16: flags (type: PT_FLAGS32) */
	evt_test->assert_numeric_param(16, (uint32_t)PPM_CL_CLONE_THREAD | PPM_CL_CLONE_SIGHAND | PPM_CL_CLONE_VM | PPM_CL_CHILD_IN_PIDNS);
