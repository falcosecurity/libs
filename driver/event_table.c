...
const struct ppm_event_info g_event_info[] = {
        ...
        [PPME_SOCKET_LISTEN_X] =
                {"listen", EC_NET | EC_SYSCALL, EF_USES_FD, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_FUTEX_X] =
                {"futex", EC_IPC | EC_SYSCALL, EF_NONE, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_FSTAT_E] =
                {"fstat", EC_FILE | EC_SYSCALL, EF_USES_FD, 1, {{"fd", PT_FD, PF_NA}}},
        [PPME_SYSCALL_FSTAT_X] =
                {"fstat", EC_FILE | EC_SYSCALL, EF_USES_FD, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_EPOLLWAIT_X] =
                {"epoll_wait", EC_WAIT | EC_SYSCALL, EF_WAITS, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_LSEEK_X] =
                {"lseek", EC_FILE | EC_SYSCALL, EF_USES_FD, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_LLSEEK_X] =
                {"llseek", EC_FILE | EC_SYSCALL, EF_USES_FD, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_KILL_X] =
                {"kill", EC_SIGNAL | EC_SYSCALL, EF_NONE, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_TKILL_X] =
                {"tkill", EC_SIGNAL | EC_SYSCALL, EF_NONE, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_TGKILL_X] =
                {"tgkill", EC_SIGNAL | EC_SYSCALL, EF_NONE, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_NANOSLEEP_X] =
                {"nanosleep", EC_SLEEP | EC_SYSCALL, EF_WAITS, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_SPLICE_X] =
                {"splice", EC_IO_OTHER | EC_SYSCALL, EF_USES_FD, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_IOCTL_3_X] =
                {"ioctl", EC_IO_OTHER | EC_SYSCALL, EF_USES_FD, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_SENDFILE_X] = {"sendfile",
                                     ...
                                     EF_USES_FD,
                                     2,
                                     {{"res", PT_ERRNO, PF_DEC}, {"offset", PT_UINT64, PF_DEC}}},
        ...
        [PPME_SYSCALL_GETDENTS_E] =
                {"getdents", EC_FILE | EC_SYSCALL, EF_USES_FD, 1, {{"fd", PT_FD, PF_NA}}},
        [PPME_SYSCALL_GETDENTS_X] =
                {"getdents", EC_FILE | EC_SYSCALL, EF_USES_FD, 1, {{"res", PT_ERRNO, PF_DEC}}},
        [PPME_SYSCALL_GETDENTS64_E] =
                {"getdents64", EC_FILE | EC_SYSCALL, EF_USES_FD, 1, {{"fd", PT_FD, PF_NA}}},
        [PPME_SYSCALL_GETDENTS64_X] =
                {"getdents64", EC_FILE | EC_SYSCALL, EF_USES_FD, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_SETNS_X] =
                {"setns", EC_PROCESS | EC_SYSCALL, EF_USES_FD, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_MKDIR_2_E] =
                {"mkdir", EC_FILE | EC_SYSCALL, EF_NONE, 1, {{"mode", PT_UINT32, PF_HEX}}},
        ...
        [PPME_SYSCALL_UNSHARE_X] =
                {"unshare", EC_PROCESS | EC_SYSCALL, EF_NONE, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_SECCOMP_X] =
                {"seccomp", EC_OTHER | EC_SYSCALL, EF_NONE, 1, {{"res", PT_ERRNO, PF_DEC}}},
        ...
        [PPME_SYSCALL_MPROTECT_X] =
                {"mprotect", EC_MEMORY | EC_SYSCALL, EF_NONE, 1, {{"res", PT_ERRNO, PF_DEC}}},
