...
const struct ppm_event_info g_event_info[] = {
        ...
        [PPME_SYSCALL_NEWSELECT_E] = {"select",
                                      EC_WAIT | EC_SYSCALL,
                                      EF_WAITS | EF_OLD_VERSION | EF_TMP_CONVERTER_MANAGED,
                                      0},
        ...
        [PPME_SYSCALL_IOCTL_2_E] = {"ioctl",
                                    EC_IO_OTHER | EC_SYSCALL,
                                    EF_USES_FD | EF_OLD_VERSION | EF_TMP_CONVERTER_MANAGED,
                                    2,
        ...
        [PPME_SCHEDSWITCH_1_E] = {"switch",
                                  ...
                                  EF_SKIPPARSERESET | EF_OLD_VERSION | EF_TMP_CONVERTER_MANAGED,
                                  1,
                                  {{"next", PT_PID, PF_DEC}}},
        ...
        [PPME_SYSCALL_BPF_E] = {"bpf",
                                EC_OTHER | EC_SYSCALL,
                                EF_CREATES_FD | EF_OLD_VERSION | EF_TMP_CONVERTER_MANAGED,
                                1,
                                {{"cmd", PT_INT64, PF_DEC}}},
        [PPME_SYSCALL_BPF_X] =
                {"bpf",
