...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SYSCALL_FSCONFIG_X */{"fsconfig", EC_SYSTEM, EF_USES_FD, 6, {{"res", PT_ERRNO, PF_DEC}, {"fs_fd", PT_FD, PF_DEC}, {"cmd", PT_ENUMFLAGS32, PF_DEC, fsconfig_cmds}, {"key", PT_CHARBUF, PF_NA}, {"value", PT_BYTEBUF, PF_NA}, {"aux", PT_INT32, PF_DEC}}},
