...
const struct ppm_event_info g_event_info[] = {
	...
	[PPME_SYSCALL_MEMFD_CREATE_X] = {"memfd_create", EC_MEMORY | EC_SYSCALL, EF_CREATES_FD | EF_NONE, 3, {{"fd",PT_FD,PF_DEC},{"name", PT_CHARBUF, PF_NA},{"flags", PT_UINT32, PF_HEX, memfd_create_flags} } },
};
