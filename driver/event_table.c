...
const struct ppm_event_info g_event_info[] = {
        ...
        [PPME_SYSCALL_EXECVE_8_E] = {"execve",
                                     ...
                                     EF_OLD_VERSION | EF_MODIFIES_STATE | EF_TMP_CONVERTER_MANAGED,
                                     0},
        ...
        [PPME_PROCEXIT_X] = {"NA",
                             EC_UNKNOWN,
                             EF_OLD_VERSION | EF_UNUSED | EF_TMP_CONVERTER_MANAGED,
                             0},
        ...
        [PPME_SOCKET_LISTEN_E] = {"listen",
                                  EC_NET | EC_SYSCALL,
                                  EF_OLD_VERSION | EF_USES_FD | EF_TMP_CONVERTER_MANAGED,
                                  2,
        ...
        [PPME_SYSCALL_EPOLLWAIT_E] = {"epoll_wait",
                                      EC_WAIT | EC_SYSCALL,
                                      EF_OLD_VERSION | EF_WAITS | EF_TMP_CONVERTER_MANAGED,
                                      1,
        ...
        [PPME_SYSCALL_NEWSELECT_E] = {"select",
                                      EC_WAIT | EC_SYSCALL,
                                      EF_OLD_VERSION | EF_WAITS | EF_TMP_CONVERTER_MANAGED,
                                      0},
        ...
        [PPME_SYSCALL_PREAD_E] =
                {"pread",
                 EC_IO_READ | EC_SYSCALL,
                 EF_OLD_VERSION | EF_USES_FD | EF_READS_FROM_FD | EF_TMP_CONVERTER_MANAGED,
                 3,
        ...
        [PPME_SYSCALL_PWRITE_E] =
                {"pwrite",
                 EC_IO_WRITE | EC_SYSCALL,
                 EF_OLD_VERSION | EF_USES_FD | EF_WRITES_TO_FD | EF_TMP_CONVERTER_MANAGED,
                 3,
                 {{"fd", PT_FD, PF_DEC}, {"size", PT_UINT32, PF_DEC}, {"pos", PT_UINT64, PF_DEC}}},
        ...
        [PPME_SYSCALL_SIGNALFD_E] =
                {"signalfd",
                 ...
                 EF_OLD_VERSION | EF_CREATES_FD | EF_MODIFIES_STATE | EF_TMP_CONVERTER_MANAGED,
                 3,
        ...
        [PPME_SCHEDSWITCH_1_E] = {"switch",
                                  ...
                                  EF_OLD_VERSION | EF_SKIPPARSERESET | EF_TMP_CONVERTER_MANAGED,
                                  1,
                                  {{"next", PT_PID, PF_DEC}}},
        [PPME_SCHEDSWITCH_1_X] = {"NA",
                                  EC_UNKNOWN,
                                  EF_OLD_VERSION | EF_SKIPPARSERESET | EF_UNUSED |
                                          EF_TMP_CONVERTER_MANAGED,
                                  0},
        [PPME_DROP_E] = {"drop",
        ...
        [PPME_SYSCALL_BPF_E] = {"bpf",
                                EC_OTHER | EC_SYSCALL,
                                EF_OLD_VERSION | EF_CREATES_FD | EF_TMP_CONVERTER_MANAGED,
                                1,
                                {{"cmd", PT_INT64, PF_DEC}}},
        [PPME_SYSCALL_BPF_X] =
                {"bpf",
        ...
        [PPME_SYSCALL_COPY_FILE_RANGE_E] = {"copy_file_range",
                                            EC_FILE | EC_SYSCALL,
                                            EF_OLD_VERSION | EF_USES_FD | EF_READS_FROM_FD |
                                                    EF_WRITES_TO_FD | EF_TMP_CONVERTER_MANAGED,
                                            3,
                                            {{"fdin", PT_FD, PF_DEC},
