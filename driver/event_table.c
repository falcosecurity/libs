...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SYSCALL_IO_URING_SETUP_E */ {"io_uring_setup", EC_OTHER, EF_CREATES_FD | EF_MODIFIES_STATE, 0},
	/* PPME_SYSCALL_IO_URING_SETUP_X */ {"io_uring_setup", EC_OTHER, EF_CREATES_FD | EF_MODIFIES_STATE, 8, {{"res", PT_ERRNO, PF_DEC},  {"entries", PT_UINT32, PF_DEC}, {"sq_entries", PT_UINT32, PF_DEC},{"cq_entries", PT_UINT32, PF_DEC},{"flags", PT_FLAGS32, PF_HEX, io_uring_setup_flags},{"sq_thread_cpu", PT_UINT32, PF_DEC}, {"sq_thread_idle", PT_UINT32, PF_DEC},{"features", PT_FLAGS32, PF_HEX, io_uring_setup_feats}}},
	/* PPME_SYSCALL_IO_URING_ENTER_E */ {"io_uring_enter", EC_IO_OTHER, EF_USES_FD | EF_WRITES_TO_FD, 0},
	...
	/* PPME_SYSCALL_IO_URING_REGISTER_E */ {"io_uring_register", EC_OTHER, EF_USES_FD | EF_MODIFIES_STATE, 0},
	/* PPME_SYSCALL_TO_URING_REGISTER_X */ {"io_uring_register", EC_OTHER, EF_USES_FD | EF_MODIFIES_STATE, 5, {{"res", PT_ERRNO, PF_DEC}, {"fd", PT_FD, PF_DEC }, {"opcode", PT_ENUMFLAGS16, PF_DEC,  io_uring_register_opcodes}, {"arg", PT_UINT64, PF_HEX}, {"nr_args", PT_UINT32, PF_DEC}}},
