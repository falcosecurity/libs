...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SOCKET_SENDMMSG_E */{"sendmmsg", EC_IO_WRITE, EF_USES_FD | EF_WRITES_TO_FD | EF_MODIFIES_STATE, 1, {{"fd", PT_FD, PF_DEC} } },
	/* PPME_SOCKET_SENDMMSG_X */{"sendmmsg", EC_IO_WRITE, EF_USES_FD | EF_WRITES_TO_FD | EF_MODIFIES_STATE, 3, {{"res", PT_ERRNO, PF_DEC}, {"vlen", PT_UINT32, PF_DEC}, {"data", PT_BYTEBUF, PF_NA} } },
	...
	/* PPME_TCP_SET_STATE_E */{"tcp_set_state", EC_NET, EF_DROP_SIMPLE_CONS | EF_NONE_PARSE, 3, {{"tuple", PT_SOCKTUPLE, PF_NA}, {"old_state", PT_INT32, PF_NA}, {"new_state", PT_INT32, PF_NA}} },
	/* PPME_TCP_SET_STATE_X */{"tcp_set_state", EC_NET, EF_UNUSED, 0},
