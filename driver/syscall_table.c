...
const struct syscall_evt_pair g_syscall_table[SYSCALL_TABLE_SIZE] = {
...
#endif
	[__NR_close - SYSCALL_TABLE_ID0] =                      {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_CLOSE_E, PPME_SYSCALL_CLOSE_X, PPM_SC_CLOSE},
	...
	[__NR_execve - SYSCALL_TABLE_ID0] =                     {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_EXECVE_19_E, PPME_SYSCALL_EXECVE_19_X, PPM_SC_EXECVE},
	[__NR_clone - SYSCALL_TABLE_ID0] =                      {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_CLONE_20_E, PPME_SYSCALL_CLONE_20_X, PPM_SC_CLONE},
#ifdef __NR_fork
	[__NR_fork - SYSCALL_TABLE_ID0] =                       {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_FORK_20_E, PPME_SYSCALL_FORK_20_X, PPM_SC_FORK},
#endif
#ifdef __NR_vfork
	[__NR_vfork - SYSCALL_TABLE_ID0] =                      {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_VFORK_20_E, PPME_SYSCALL_VFORK_20_X, PPM_SC_VFORK},
#endif
#ifdef __NR_pipe
...
#endif
	[__NR_chdir - SYSCALL_TABLE_ID0] =                      {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_CHDIR_E, PPME_SYSCALL_CHDIR_X, PPM_SC_CHDIR},
	[__NR_fchdir - SYSCALL_TABLE_ID0] =                     {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_FCHDIR_E, PPME_SYSCALL_FCHDIR_X, PPM_SC_FCHDIR},
#ifdef __NR_mkdir
	...
	[__NR_dup - SYSCALL_TABLE_ID0] =                        {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_DUP_E, PPME_SYSCALL_DUP_X, PPM_SC_DUP},
#ifdef __NR_dup2
	[__NR_dup2 - SYSCALL_TABLE_ID0] =                       {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_DUP_E, PPME_SYSCALL_DUP_X, PPM_SC_DUP2},
#endif
	[__NR_dup3 - SYSCALL_TABLE_ID0] =                       {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_DUP_E, PPME_SYSCALL_DUP_X, PPM_SC_DUP3},
#ifdef __NR_signalfd
	...
	[__NR_getrlimit - SYSCALL_TABLE_ID0] =                  {UF_USED | UF_NEVER_DROP, PPME_SYSCALL_GETRLIMIT_E, PPME_SYSCALL_GETRLIMIT_X, PPM_SC_GETRLIMIT},
#endif
	...
	[__NR_ugetrlimit - SYSCALL_TABLE_ID0] =                 {UF_USED | UF_NEVER_DROP, PPME_SYSCALL_GETRLIMIT_E, PPME_SYSCALL_GETRLIMIT_X, PPM_SC_UGETRLIMIT},
#endif
...
/* [__NR_old_select - SYSCALL_TABLE_ID0] =	{UF_USED, PPME_GENERIC_E, PPME_GENERIC_X}, */
	...
	[__NR_socket - SYSCALL_TABLE_ID0] =                     {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SOCKET_SOCKET_E, PPME_SOCKET_SOCKET_X, PPM_SC_SOCKET},
	[__NR_bind - SYSCALL_TABLE_ID0] =                       {UF_USED | UF_NEVER_DROP, PPME_SOCKET_BIND_E,  PPME_SOCKET_BIND_X, PPM_SC_BIND},
	[__NR_connect - SYSCALL_TABLE_ID0] =                    {UF_USED | UF_SIMPLEDRIVER_KEEP, PPME_SOCKET_CONNECT_E, PPME_SOCKET_CONNECT_X, PPM_SC_CONNECT},
	[__NR_listen - SYSCALL_TABLE_ID0] =                     {UF_USED, PPME_SOCKET_LISTEN_E, PPME_SOCKET_LISTEN_X, PPM_SC_LISTEN},
	[__NR_accept - SYSCALL_TABLE_ID0] =                     {UF_USED | UF_SIMPLEDRIVER_KEEP, PPME_SOCKET_ACCEPT_5_E, PPME_SOCKET_ACCEPT_5_X, PPM_SC_ACCEPT},
	...
	[__NR_accept4 - SYSCALL_TABLE_ID0] =                    {UF_USED | UF_SIMPLEDRIVER_KEEP, PPME_SOCKET_ACCEPT4_5_E, PPME_SOCKET_ACCEPT4_5_X, PPM_SC_ACCEPT4},
#endif
...
#endif
#ifdef __NR_getgid32
	[__NR_getgid32 - SYSCALL_TABLE_ID0] =                   {UF_USED, PPME_SYSCALL_GETGID_E, PPME_SYSCALL_GETGID_X, PPM_SC_GETGID},
#endif
#ifdef __NR_getegid
	[__NR_getegid - SYSCALL_TABLE_ID0] =                    {UF_USED, PPME_SYSCALL_GETEGID_E, PPME_SYSCALL_GETEGID_X, PPM_SC_GETEGID},
#endif
#ifdef __NR_getegid32
	[__NR_getegid32 - SYSCALL_TABLE_ID0] =                  {UF_USED, PPME_SYSCALL_GETEGID_E, PPME_SYSCALL_GETEGID_X, PPM_SC_GETEGID},
#endif
	...
	[__NR_getresgid32 - SYSCALL_TABLE_ID0] =                {UF_USED, PPME_SYSCALL_GETRESGID_E, PPME_SYSCALL_GETRESGID_X, PPM_SC_GETRESGID},
#endif
#ifdef __NR_getdents
...
#ifdef __NR_bpf
	[__NR_bpf - SYSCALL_TABLE_ID0] =                        {UF_USED, PPME_SYSCALL_BPF_E, PPME_SYSCALL_BPF_X, PPM_SC_BPF},
#endif
#ifdef __NR_seccomp
...
#endif
#ifdef __NR_clone3
	[__NR_clone3 - SYSCALL_TABLE_ID0] =                     {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_CLONE3_E, PPME_SYSCALL_CLONE3_X, PPM_SC_CLONE3},
#endif
#ifdef __NR_mprotect
	[__NR_mprotect - SYSCALL_TABLE_ID0] =                   {UF_USED, PPME_SYSCALL_MPROTECT_E, PPME_SYSCALL_MPROTECT_X, PPM_SC_MPROTECT},
#endif
#ifdef __NR_execveat
	[__NR_execveat - SYSCALL_TABLE_ID0] =                    {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_EXECVEAT_E, PPME_SYSCALL_EXECVEAT_X, PPM_SC_EXECVEAT},
#endif
...
#endif
	[__NR_restart_syscall - SYSCALL_TABLE_ID0] = { .ppm_code = PPM_SC_RESTART_SYSCALL },
	[__NR_exit - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_EXIT},
#ifdef __NR_time
	[__NR_time - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIME},
#endif
#ifdef __NR_mknod
	[__NR_mknod - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MKNOD},
#endif
	[__NR_getpid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETPID},
	[__NR_sync - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SYNC},
	[__NR_times - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMES},
	[__NR_acct - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_ACCT},
	[__NR_umask - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_UMASK},
#ifdef __NR_ustat
	[__NR_ustat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_USTAT},
#endif
	[__NR_getppid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETPPID},
#ifdef __NR_getpgrp
	[__NR_getpgrp - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETPGRP},
#endif
	[__NR_sethostname - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETHOSTNAME},
	[__NR_getrusage - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETRUSAGE},
	[__NR_gettimeofday - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETTIMEOFDAY},
	[__NR_settimeofday - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETTIMEOFDAY},
#ifdef __NR_readlink
	[__NR_readlink - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_READLINK},
#endif
	[__NR_swapon - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SWAPON},
	[__NR_reboot - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_REBOOT},
	[__NR_truncate - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TRUNCATE},
	[__NR_ftruncate - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FTRUNCATE},
	[__NR_getpriority - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_GETPRIORITY},
	[__NR_setpriority - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SETPRIORITY},
	[__NR_statfs - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_STATFS},
	[__NR_fstatfs - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_FSTATFS},
	[__NR_setitimer - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SETITIMER},
	[__NR_getitimer - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_GETITIMER},
	[__NR_uname - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_UNAME},
	[__NR_vhangup - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_VHANGUP},
	[__NR_wait4 - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_WAIT4},
	[__NR_swapoff - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SWAPOFF},
	[__NR_sysinfo - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SYSINFO},
	[__NR_fsync - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_FSYNC},
	[__NR_setdomainname - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SETDOMAINNAME},
	[__NR_adjtimex - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_ADJTIMEX},
	[__NR_init_module - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_INIT_MODULE},
	[__NR_delete_module - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_DELETE_MODULE},
	[__NR_getpgid - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_GETPGID},
#ifdef __NR_sysfs
	[__NR_sysfs - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SYSFS},
#endif
	[__NR_personality - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_PERSONALITY},
	[__NR_msync - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MSYNC},
	[__NR_getsid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETSID},
	[__NR_fdatasync - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FDATASYNC},
	[__NR_sched_setscheduler - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_SETSCHEDULER},
	[__NR_sched_getscheduler - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_GETSCHEDULER},
	[__NR_sched_yield - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_YIELD},
	[__NR_sched_get_priority_max - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_GET_PRIORITY_MAX},
	[__NR_sched_get_priority_min - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_GET_PRIORITY_MIN},
	[__NR_sched_rr_get_interval - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_RR_GET_INTERVAL},
	[__NR_mremap - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MREMAP},
	[__NR_prctl - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_PRCTL},
#ifdef __NR_arch_prctl
	[__NR_arch_prctl - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_ARCH_PRCTL},
#endif
	[__NR_rt_sigaction - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGACTION},
	[__NR_rt_sigprocmask - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGPROCMASK},
	[__NR_rt_sigpending - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGPENDING},
	[__NR_rt_sigtimedwait - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGTIMEDWAIT},
	[__NR_rt_sigqueueinfo - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGQUEUEINFO},
	[__NR_rt_sigsuspend - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGSUSPEND},
	[__NR_capget - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CAPGET},

	[__NR_setreuid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETREUID},
	[__NR_setregid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETREGID},
	[__NR_getgroups - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETGROUPS},
	[__NR_setgroups - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETGROUPS},
	[__NR_fchown - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FCHOWN},
#ifdef __NR_chown
	[__NR_chown - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CHOWN},
#endif
	[__NR_setfsuid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETFSUID},
	[__NR_setfsgid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETFSGID},
	[__NR_pivot_root - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_PIVOT_ROOT},
	[__NR_mincore - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MINCORE},
	[__NR_madvise - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MADVISE},
	[__NR_gettid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETTID},
	[__NR_setxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETXATTR},
	[__NR_lsetxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LSETXATTR},
	[__NR_fsetxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FSETXATTR},
	[__NR_getxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETXATTR},
	[__NR_lgetxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LGETXATTR},
	[__NR_fgetxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FGETXATTR},
	[__NR_listxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LISTXATTR},
	[__NR_llistxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LLISTXATTR},
	[__NR_flistxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FLISTXATTR},
	[__NR_removexattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_REMOVEXATTR},
	[__NR_lremovexattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LREMOVEXATTR},
	[__NR_fremovexattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FREMOVEXATTR},
	[__NR_sched_setaffinity - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_SETAFFINITY},
	[__NR_sched_getaffinity - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_GETAFFINITY},
#ifdef __NR_set_thread_area
	[__NR_set_thread_area - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SET_THREAD_AREA},
#endif
#ifdef __NR_get_thread_area
	[__NR_get_thread_area - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GET_THREAD_AREA},
#endif
	[__NR_io_setup - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IO_SETUP},
	[__NR_io_destroy - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IO_DESTROY},
	[__NR_io_getevents - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IO_GETEVENTS},
	[__NR_io_submit - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IO_SUBMIT},
	[__NR_io_cancel - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IO_CANCEL},
	[__NR_exit_group - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_EXIT_GROUP},
	[__NR_remap_file_pages - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_REMAP_FILE_PAGES},
	[__NR_set_tid_address - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SET_TID_ADDRESS},
	[__NR_timer_create - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMER_CREATE},
	[__NR_timer_settime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMER_SETTIME},
	[__NR_timer_gettime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMER_GETTIME},
	[__NR_timer_getoverrun - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMER_GETOVERRUN},
	[__NR_timer_delete - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMER_DELETE},
	[__NR_clock_settime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CLOCK_SETTIME},
	[__NR_clock_gettime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CLOCK_GETTIME},
	[__NR_clock_getres - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CLOCK_GETRES},
	[__NR_clock_nanosleep - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CLOCK_NANOSLEEP},
#ifdef __NR_utimes
	[__NR_utimes - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_UTIMES},
#endif
	[__NR_mq_open - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_OPEN},
	[__NR_mq_unlink - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_UNLINK},
	[__NR_mq_timedsend - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_TIMEDSEND},
	[__NR_mq_timedreceive - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_TIMEDRECEIVE},
	[__NR_mq_notify - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_NOTIFY},
	[__NR_mq_getsetattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_GETSETATTR},
	[__NR_kexec_load - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_KEXEC_LOAD},
	[__NR_waitid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_WAITID},
	[__NR_add_key - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_ADD_KEY},
	[__NR_request_key - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_REQUEST_KEY},
	[__NR_keyctl - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_KEYCTL},
	[__NR_ioprio_set - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IOPRIO_SET},
	[__NR_ioprio_get - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IOPRIO_GET},
	[__NR_inotify_add_watch - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_INOTIFY_ADD_WATCH},
	[__NR_inotify_rm_watch - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_INOTIFY_RM_WATCH},
	[__NR_mknodat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MKNODAT},
	[__NR_fchownat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FCHOWNAT},
#ifdef __NR_futimesat
	[__NR_futimesat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FUTIMESAT},
#endif
	[__NR_readlinkat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_READLINKAT},
	[__NR_faccessat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FACCESSAT},
	[__NR_set_robust_list - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SET_ROBUST_LIST},
	[__NR_get_robust_list - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GET_ROBUST_LIST},
	[__NR_tee - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TEE},
	[__NR_vmsplice - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_VMSPLICE},
#ifdef __NR_getcpu
	[__NR_getcpu - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETCPU},
#endif
	[__NR_epoll_pwait - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_EPOLL_PWAIT},
	[__NR_utimensat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_UTIMENSAT},
	[__NR_timerfd_settime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMERFD_SETTIME},
	[__NR_timerfd_gettime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMERFD_GETTIME},
	[__NR_epoll_create1 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_EPOLL_CREATE1},
	[__NR_rt_tgsigqueueinfo - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_TGSIGQUEUEINFO},
	[__NR_perf_event_open - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_PERF_EVENT_OPEN},
#ifdef __NR_fanotify_init
	[__NR_fanotify_init - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FANOTIFY_INIT},
#endif
#ifdef __NR_clock_adjtime
	[__NR_clock_adjtime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CLOCK_ADJTIME},
#endif
#ifdef __NR_syncfs
	[__NR_syncfs - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SYNCFS},
#endif
#ifdef __NR_msgsnd
	[__NR_msgsnd - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MSGSND},
#endif
#ifdef __NR_msgrcv
	[__NR_msgrcv - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MSGRCV},
#endif
#ifdef __NR_msgget
	[__NR_msgget - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MSGGET},
#endif
#ifdef __NR_msgctl
	[__NR_msgctl - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MSGCTL},
#endif
#ifdef __NR_shmdt
	[__NR_shmdt - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SHMDT},
#endif
#ifdef __NR_shmget
	[__NR_shmget - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SHMGET},
#endif
#ifdef __NR_shmctl
	[__NR_shmctl - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SHMCTL},
#endif
#ifdef __NR_statfs64
	[__NR_statfs64 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_STATFS64},
#endif
#ifdef __NR_fstatfs64
	[__NR_fstatfs64 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FSTATFS64},
#endif
#ifdef __NR_fstatat64
	[__NR_fstatat64 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FSTATAT64},
#endif
#ifdef __NR_bdflush
	[__NR_bdflush - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_BDFLUSH},
#endif
#ifdef __NR_sigprocmask
	[__NR_sigprocmask - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SIGPROCMASK},
#endif
#ifdef __NR_ipc
	[__NR_ipc - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IPC},
#endif
#ifdef __NR_lstat64
	[__NR_lstat64 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LSTAT64},
#endif
#ifdef __NR__newselect
	[__NR__newselect - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC__NEWSELECT},
#endif
#ifdef __NR_sgetmask
	[__NR_sgetmask - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SGETMASK},
#endif
#ifdef __NR_ssetmask
	[__NR_ssetmask - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SSETMASK},
#endif
#ifdef __NR_sigpending
	[__NR_sigpending - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SIGPENDING},
#endif
#ifdef __NR_olduname
	[__NR_olduname - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_OLDUNAME},
#endif
#ifdef __NR_umount
	[__NR_umount - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_UMOUNT},
#endif
#ifdef __NR_signal
	[__NR_signal - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SIGNAL},
#endif
#ifdef __NR_nice
	[__NR_nice - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_NICE},
#endif
#ifdef __NR_stime
	[__NR_stime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_STIME},
#endif
#ifdef __NR_waitpid
	[__NR_waitpid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_WAITPID},
#endif
#ifdef __NR_shmat
	[__NR_shmat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SHMAT},
#endif
#ifdef __NR_rt_sigreturn
	[__NR_rt_sigreturn - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SIGRETURN},
#endif
#ifdef __NR_fallocate
	[__NR_fallocate - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FALLOCATE},
#endif
#ifdef __NR_newfstatat
	[__NR_newfstatat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_NEWFSSTAT},
#endif
#ifdef __NR_finit_module
	[__NR_finit_module - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FINIT_MODULE},
#endif
#ifdef __NR_sigaltstack
	[__NR_sigaltstack - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SIGALTSTACK},
#endif
#ifdef __NR_getrandom
	[__NR_getrandom - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETRANDOM},
#endif
#ifdef __NR_fadvise64
	[__NR_fadvise64 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FADVISE64},
#endif
};
...
const struct syscall_evt_pair g_syscall_ia32_table[SYSCALL_TABLE_SIZE] = {
...
#endif
	[__NR_ia32_close - SYSCALL_TABLE_ID0] =                      {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_CLOSE_E, PPME_SYSCALL_CLOSE_X, PPM_SC_CLOSE},
	...
	[__NR_ia32_execve - SYSCALL_TABLE_ID0] =                     {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_EXECVE_19_E, PPME_SYSCALL_EXECVE_19_X, PPM_SC_EXECVE},
	[__NR_ia32_clone - SYSCALL_TABLE_ID0] =                      {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_CLONE_20_E, PPME_SYSCALL_CLONE_20_X, PPM_SC_CLONE},
#ifdef __NR_ia32_fork
	[__NR_ia32_fork - SYSCALL_TABLE_ID0] =                       {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_FORK_20_E, PPME_SYSCALL_FORK_20_X, PPM_SC_FORK},
#endif
#ifdef __NR_ia32_vfork
	[__NR_ia32_vfork - SYSCALL_TABLE_ID0] =                      {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_VFORK_20_E, PPME_SYSCALL_VFORK_20_X, PPM_SC_VFORK},
#endif
...
#endif
	[__NR_ia32_chdir - SYSCALL_TABLE_ID0] =                      {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_CHDIR_E, PPME_SYSCALL_CHDIR_X, PPM_SC_CHDIR},
	[__NR_ia32_fchdir - SYSCALL_TABLE_ID0] =                     {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_FCHDIR_E, PPME_SYSCALL_FCHDIR_X, PPM_SC_FCHDIR},
	...
	[__NR_ia32_dup - SYSCALL_TABLE_ID0] =                        {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_DUP_E, PPME_SYSCALL_DUP_X, PPM_SC_DUP},
#ifdef __NR_ia32_dup2
	[__NR_ia32_dup2 - SYSCALL_TABLE_ID0] =                       {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_DUP_E, PPME_SYSCALL_DUP_X, PPM_SC_DUP2},
#endif
	[__NR_ia32_dup3 - SYSCALL_TABLE_ID0] =                       {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_DUP_E, PPME_SYSCALL_DUP_X, PPM_SC_DUP3},
	...
	[__NR_ia32_getrlimit - SYSCALL_TABLE_ID0] =                  {UF_USED | UF_NEVER_DROP, PPME_SYSCALL_GETRLIMIT_E, PPME_SYSCALL_GETRLIMIT_X, PPM_SC_GETRLIMIT},
#endif
	...
	[__NR_ia32_ugetrlimit - SYSCALL_TABLE_ID0] =                 {UF_USED | UF_NEVER_DROP, PPME_SYSCALL_GETRLIMIT_E, PPME_SYSCALL_GETRLIMIT_X, PPM_SC_UGETRLIMIT},
#endif
	...
	[__NR_ia32_socket - SYSCALL_TABLE_ID0] =                     {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SOCKET_SOCKET_E, PPME_SOCKET_SOCKET_X, PPM_SC_SOCKET},
	[__NR_ia32_bind - SYSCALL_TABLE_ID0] =                       {UF_USED | UF_NEVER_DROP, PPME_SOCKET_BIND_E,  PPME_SOCKET_BIND_X, PPM_SC_BIND},
	[__NR_ia32_connect - SYSCALL_TABLE_ID0] =                    {UF_USED | UF_SIMPLEDRIVER_KEEP, PPME_SOCKET_CONNECT_E, PPME_SOCKET_CONNECT_X, PPM_SC_CONNECT},
	[__NR_ia32_listen - SYSCALL_TABLE_ID0] =                     {UF_USED, PPME_SOCKET_LISTEN_E, PPME_SOCKET_LISTEN_X, PPM_SC_LISTEN},
	[__NR_ia32_accept - SYSCALL_TABLE_ID0] =                     {UF_USED | UF_SIMPLEDRIVER_KEEP, PPME_SOCKET_ACCEPT_5_E, PPME_SOCKET_ACCEPT_5_X, PPM_SC_ACCEPT},
	...
	[__NR_ia32_accept4 - SYSCALL_TABLE_ID0] =                    {UF_USED | UF_SIMPLEDRIVER_KEEP, PPME_SOCKET_ACCEPT4_5_E, PPME_SOCKET_ACCEPT4_5_X, PPM_SC_ACCEPT4},
#endif
	...
	[__NR_ia32_getgid32 - SYSCALL_TABLE_ID0] =                   {UF_USED, PPME_SYSCALL_GETGID_E, PPME_SYSCALL_GETGID_X, PPM_SC_GETGID},
#endif
	...
	[__NR_ia32_getegid32 - SYSCALL_TABLE_ID0] =                  {UF_USED, PPME_SYSCALL_GETEGID_E, PPME_SYSCALL_GETEGID_X, PPM_SC_GETEGID},
	[__NR_ia32_getegid32 - SYSCALL_TABLE_ID0] =                  {UF_USED, PPME_SYSCALL_GETEGID_E, PPME_SYSCALL_GETEGID_X, PPM_SC_GETEGID},
#endif
	...
	[__NR_ia32_getresgid32 - SYSCALL_TABLE_ID0] =                {UF_USED, PPME_SYSCALL_GETRESGID_E, PPME_SYSCALL_GETRESGID_X, PPM_SC_GETRESGID},
#endif
...
#ifdef __NR_ia32_bpf
	[__NR_ia32_bpf - SYSCALL_TABLE_ID0] =                        {UF_USED, PPME_SYSCALL_BPF_E, PPME_SYSCALL_BPF_X, PPM_SC_BPF},
#endif
	...
	[__NR_ia32_clone3 - SYSCALL_TABLE_ID0] =                     {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_CLONE3_E, PPME_SYSCALL_CLONE3_X, PPM_SC_CLONE3},
#endif
	...
	[__NR_ia32_execveat - SYSCALL_TABLE_ID0] =                    {UF_USED | UF_NEVER_DROP | UF_SIMPLEDRIVER_KEEP, PPME_SYSCALL_EXECVEAT_E, PPME_SYSCALL_EXECVEAT_X, PPM_SC_EXECVEAT},
#endif
...
#endif
	[__NR_ia32_restart_syscall - SYSCALL_TABLE_ID0] = { .ppm_code = PPM_SC_RESTART_SYSCALL },
	[__NR_ia32_exit - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_EXIT},
#ifdef __NR_ia32_time
	[__NR_ia32_time - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIME},
#endif
#ifdef __NR_ia32_mknod
	[__NR_ia32_mknod - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MKNOD},
#endif
	[__NR_ia32_getpid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETPID},
	[__NR_ia32_sync - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SYNC},
	[__NR_ia32_times - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMES},
	[__NR_ia32_acct - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_ACCT},
	[__NR_ia32_umask - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_UMASK},
#ifdef __NR_ia32_ustat
	[__NR_ia32_ustat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_USTAT},
#endif
	[__NR_ia32_getppid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETPPID},
#ifdef __NR_ia32_getpgrp
	[__NR_ia32_getpgrp - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETPGRP},
#endif
	[__NR_ia32_sethostname - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETHOSTNAME},
	[__NR_ia32_getrusage - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETRUSAGE},
	[__NR_ia32_gettimeofday - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETTIMEOFDAY},
	[__NR_ia32_settimeofday - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETTIMEOFDAY},
#ifdef __NR_ia32_readlink
	[__NR_ia32_readlink - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_READLINK},
#endif
	[__NR_ia32_swapon - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SWAPON},
	[__NR_ia32_reboot - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_REBOOT},
	[__NR_ia32_truncate - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TRUNCATE},
	[__NR_ia32_ftruncate - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FTRUNCATE},
	[__NR_ia32_getpriority - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_GETPRIORITY},
	[__NR_ia32_setpriority - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SETPRIORITY},
	[__NR_ia32_statfs - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_STATFS},
	[__NR_ia32_fstatfs - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_FSTATFS},
	[__NR_ia32_setitimer - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SETITIMER},
	[__NR_ia32_getitimer - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_GETITIMER},
	[__NR_ia32_uname - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_UNAME},
	[__NR_ia32_vhangup - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_VHANGUP},
	[__NR_ia32_wait4 - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_WAIT4},
	[__NR_ia32_swapoff - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SWAPOFF},
	[__NR_ia32_sysinfo - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SYSINFO},
	[__NR_ia32_fsync - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_FSYNC},
	[__NR_ia32_setdomainname - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_SETDOMAINNAME},
	[__NR_ia32_adjtimex - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_ADJTIMEX},
	[__NR_ia32_init_module - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_INIT_MODULE},
	[__NR_ia32_delete_module - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_DELETE_MODULE},
	[__NR_ia32_getpgid - SYSCALL_TABLE_ID0] = {.ppm_code= PPM_SC_GETPGID},
#ifdef __NR_ia32_sysfs
	[__NR_ia32_sysfs - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SYSFS},
#endif
	[__NR_ia32_personality - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_PERSONALITY},
	[__NR_ia32_msync - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MSYNC},
	[__NR_ia32_getsid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETSID},
	[__NR_ia32_fdatasync - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FDATASYNC},
	[__NR_ia32_sched_setscheduler - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_SETSCHEDULER},
	[__NR_ia32_sched_getscheduler - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_GETSCHEDULER},
	[__NR_ia32_sched_yield - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_YIELD},
	[__NR_ia32_sched_get_priority_max - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_GET_PRIORITY_MAX},
	[__NR_ia32_sched_get_priority_min - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_GET_PRIORITY_MIN},
	[__NR_ia32_sched_rr_get_interval - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_RR_GET_INTERVAL},
	[__NR_ia32_mremap - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MREMAP},
	[__NR_ia32_prctl - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_PRCTL},
#ifdef __NR_ia32_arch_prctl
	[__NR_ia32_arch_prctl - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_ARCH_PRCTL},
#endif
	[__NR_ia32_rt_sigaction - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGACTION},
	[__NR_ia32_rt_sigprocmask - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGPROCMASK},
	[__NR_ia32_rt_sigpending - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGPENDING},
	[__NR_ia32_rt_sigtimedwait - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGTIMEDWAIT},
	[__NR_ia32_rt_sigqueueinfo - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGQUEUEINFO},
	[__NR_ia32_rt_sigsuspend - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_SIGSUSPEND},
	[__NR_ia32_capget - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CAPGET},

	[__NR_ia32_setreuid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETREUID},
	[__NR_ia32_setregid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETREGID},
	[__NR_ia32_getgroups - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETGROUPS},
	[__NR_ia32_setgroups - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETGROUPS},
	[__NR_ia32_fchown - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FCHOWN},
#ifdef __NR_ia32_chown
	[__NR_ia32_chown - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CHOWN},
#endif
	[__NR_ia32_setfsuid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETFSUID},
	[__NR_ia32_setfsgid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETFSGID},
	[__NR_ia32_pivot_root - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_PIVOT_ROOT},
	[__NR_ia32_mincore - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MINCORE},
	[__NR_ia32_madvise - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MADVISE},
	[__NR_ia32_gettid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETTID},
	[__NR_ia32_setxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SETXATTR},
	[__NR_ia32_lsetxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LSETXATTR},
	[__NR_ia32_fsetxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FSETXATTR},
	[__NR_ia32_getxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETXATTR},
	[__NR_ia32_lgetxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LGETXATTR},
	[__NR_ia32_fgetxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FGETXATTR},
	[__NR_ia32_listxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LISTXATTR},
	[__NR_ia32_llistxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LLISTXATTR},
	[__NR_ia32_flistxattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FLISTXATTR},
	[__NR_ia32_removexattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_REMOVEXATTR},
	[__NR_ia32_lremovexattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LREMOVEXATTR},
	[__NR_ia32_fremovexattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FREMOVEXATTR},
	[__NR_ia32_sched_setaffinity - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_SETAFFINITY},
	[__NR_ia32_sched_getaffinity - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SCHED_GETAFFINITY},
#ifdef __NR_ia32_set_thread_area
	[__NR_ia32_set_thread_area - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SET_THREAD_AREA},
#endif
#ifdef __NR_ia32_get_thread_area
	[__NR_ia32_get_thread_area - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GET_THREAD_AREA},
#endif
	[__NR_ia32_io_setup - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IO_SETUP},
	[__NR_ia32_io_destroy - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IO_DESTROY},
	[__NR_ia32_io_getevents - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IO_GETEVENTS},
	[__NR_ia32_io_submit - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IO_SUBMIT},
	[__NR_ia32_io_cancel - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IO_CANCEL},
	[__NR_ia32_exit_group - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_EXIT_GROUP},
	[__NR_ia32_remap_file_pages - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_REMAP_FILE_PAGES},
	[__NR_ia32_set_tid_address - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SET_TID_ADDRESS},
	[__NR_ia32_timer_create - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMER_CREATE},
	[__NR_ia32_timer_settime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMER_SETTIME},
	[__NR_ia32_timer_gettime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMER_GETTIME},
	[__NR_ia32_timer_getoverrun - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMER_GETOVERRUN},
	[__NR_ia32_timer_delete - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMER_DELETE},
	[__NR_ia32_clock_settime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CLOCK_SETTIME},
	[__NR_ia32_clock_gettime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CLOCK_GETTIME},
	[__NR_ia32_clock_getres - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CLOCK_GETRES},
	[__NR_ia32_clock_nanosleep - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CLOCK_NANOSLEEP},
#ifdef __NR_ia32_utimes
	[__NR_ia32_utimes - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_UTIMES},
#endif
	[__NR_ia32_mq_open - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_OPEN},
	[__NR_ia32_mq_unlink - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_UNLINK},
	[__NR_ia32_mq_timedsend - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_TIMEDSEND},
	[__NR_ia32_mq_timedreceive - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_TIMEDRECEIVE},
	[__NR_ia32_mq_notify - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_NOTIFY},
	[__NR_ia32_mq_getsetattr - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MQ_GETSETATTR},
	[__NR_ia32_kexec_load - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_KEXEC_LOAD},
	[__NR_ia32_waitid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_WAITID},
	[__NR_ia32_add_key - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_ADD_KEY},
	[__NR_ia32_request_key - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_REQUEST_KEY},
	[__NR_ia32_keyctl - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_KEYCTL},
	[__NR_ia32_ioprio_set - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IOPRIO_SET},
	[__NR_ia32_ioprio_get - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IOPRIO_GET},
	[__NR_ia32_inotify_add_watch - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_INOTIFY_ADD_WATCH},
	[__NR_ia32_inotify_rm_watch - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_INOTIFY_RM_WATCH},
	[__NR_ia32_mknodat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MKNODAT},
	[__NR_ia32_fchownat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FCHOWNAT},
#ifdef __NR_ia32_futimesat
	[__NR_ia32_futimesat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FUTIMESAT},
#endif
	[__NR_ia32_readlinkat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_READLINKAT},
	[__NR_ia32_faccessat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FACCESSAT},
	[__NR_ia32_set_robust_list - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SET_ROBUST_LIST},
	[__NR_ia32_get_robust_list - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GET_ROBUST_LIST},
	[__NR_ia32_tee - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TEE},
	[__NR_ia32_vmsplice - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_VMSPLICE},
#ifdef __NR_ia32_getcpu
	[__NR_ia32_getcpu - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETCPU},
#endif
	[__NR_ia32_epoll_pwait - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_EPOLL_PWAIT},
	[__NR_ia32_utimensat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_UTIMENSAT},
	[__NR_ia32_timerfd_settime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMERFD_SETTIME},
	[__NR_ia32_timerfd_gettime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_TIMERFD_GETTIME},
	[__NR_ia32_epoll_create1 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_EPOLL_CREATE1},
	[__NR_ia32_rt_tgsigqueueinfo - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_RT_TGSIGQUEUEINFO},
	[__NR_ia32_perf_event_open - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_PERF_EVENT_OPEN},
#ifdef __NR_ia32_fanotify_init
	[__NR_ia32_fanotify_init - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FANOTIFY_INIT},
#endif
#ifdef __NR_ia32_clock_adjtime
	[__NR_ia32_clock_adjtime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_CLOCK_ADJTIME},
#endif
#ifdef __NR_ia32_syncfs
	[__NR_ia32_syncfs - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SYNCFS},
#endif
#ifdef __NR_ia32_msgsnd
	[__NR_ia32_msgsnd - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MSGSND},
#endif
#ifdef __NR_ia32_msgrcv
	[__NR_ia32_msgrcv - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MSGRCV},
#endif
#ifdef __NR_ia32_msgget
	[__NR_ia32_msgget - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MSGGET},
#endif
#ifdef __NR_ia32_msgctl
	[__NR_ia32_msgctl - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_MSGCTL},
#endif
#ifdef __NR_ia32_shmdt
	[__NR_ia32_shmdt - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SHMDT},
#endif
#ifdef __NR_ia32_shmget
	[__NR_ia32_shmget - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SHMGET},
#endif
#ifdef __NR_ia32_shmctl
	[__NR_ia32_shmctl - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SHMCTL},
#endif
#ifdef __NR_ia32_statfs64
	[__NR_ia32_statfs64 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_STATFS64},
#endif
#ifdef __NR_ia32_fstatfs64
	[__NR_ia32_fstatfs64 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FSTATFS64},
#endif
#ifdef __NR_ia32_fstatat64
	[__NR_ia32_fstatat64 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FSTATAT64},
#endif
#ifdef __NR_ia32_bdflush
	[__NR_ia32_bdflush - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_BDFLUSH},
#endif
#ifdef __NR_ia32_sigprocmask
	[__NR_ia32_sigprocmask - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SIGPROCMASK},
#endif
#ifdef __NR_ia32_ipc
	[__NR_ia32_ipc - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_IPC},
#endif
#ifdef __NR_ia32_lstat64
	[__NR_ia32_lstat64 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_LSTAT64},
#endif
#ifdef __NR_ia32__newselect
	[__NR_ia32__newselect - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC__NEWSELECT},
#endif
#ifdef __NR_ia32_sgetmask
	[__NR_ia32_sgetmask - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SGETMASK},
#endif
#ifdef __NR_ia32_ssetmask
	[__NR_ia32_ssetmask - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SSETMASK},
#endif
#ifdef __NR_ia32_sigpending
	[__NR_ia32_sigpending - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SIGPENDING},
#endif
#ifdef __NR_ia32_olduname
	[__NR_ia32_olduname - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_OLDUNAME},
#endif
#ifdef __NR_ia32_umount
	[__NR_ia32_umount - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_UMOUNT},
#endif
#ifdef __NR_ia32_signal
	[__NR_ia32_signal - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SIGNAL},
#endif
#ifdef __NR_ia32_nice
	[__NR_ia32_nice - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_NICE},
#endif
#ifdef __NR_ia32_stime
	[__NR_ia32_stime - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_STIME},
#endif
#ifdef __NR_ia32_waitpid
	[__NR_ia32_waitpid - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_WAITPID},
#endif
#ifdef __NR_ia32_shmat
	[__NR_ia32_shmat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SHMAT},
#endif
#ifdef __NR_ia32_rt_sigreturn
	[__NR_ia32_rt_sigreturn - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SIGRETURN},
#endif
#ifdef __NR_ia32_fallocate
	[__NR_ia32_fallocate - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FALLOCATE},
#endif
#ifdef __NR_ia32_newfstatat
	[__NR_ia32_newfstatat - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_NEWFSSTAT},
#endif
#ifdef __NR_ia32_finit_module
	[__NR_ia32_finit_module - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FINIT_MODULE},
#endif
#ifdef __NR_ia32_sigaltstack
	[__NR_ia32_sigaltstack - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_SIGALTSTACK},
#endif
#ifdef __NR_ia32_getrandom
	[__NR_ia32_getrandom - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_GETRANDOM},
#endif
#ifdef __NR_ia32_fadvise64
	[__NR_ia32_fadvise64 - SYSCALL_TABLE_ID0] = {.ppm_code = PPM_SC_FADVISE64},
#endif
};
