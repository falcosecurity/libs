...
const struct ppm_event_entry g_ppm_events[PPM_EVENT_MAX] = {
        ...
        [PPME_SYSCALL_SETRESUID_E] = {FILLER_DISABLED},
        [PPME_SYSCALL_SETRESUID_X] = {FILLER_REF(sys_setresuid_x)},
        [PPME_SYSCALL_SETRESGID_E] = {FILLER_DISABLED},
        ...
        [PPME_SYSCALL_UNSHARE_E] = {FILLER_DISABLED},
        [PPME_SYSCALL_UNSHARE_X] = {FILLER_REF(sys_unshare_x)},
        [PPME_SYSCALL_EXECVE_19_E] = {FILLER_DISABLED},
        ...
        [PPME_SYSCALL_UNLINKAT_2_E] = {FILLER_DISABLED},
        [PPME_SYSCALL_UNLINKAT_2_X] = {FILLER_REF(sys_unlinkat_x)},
        [PPME_SYSCALL_MKDIRAT_E] = {FILLER_DISABLED},
        ...
        [PPME_SYSCALL_LINK_2_E] = {FILLER_DISABLED},
        [PPME_SYSCALL_LINK_2_X] = {FILLER_REF(sys_autofill),
                                   3,
                                   APT_REG,
                                   {{AF_ID_RETVAL}, {0}, {1}}},
        [PPME_SYSCALL_LINKAT_2_E] = {FILLER_DISABLED},
        [PPME_SYSCALL_LINKAT_2_X] = {FILLER_REF(sys_linkat_x)},
        [PPME_SYSCALL_FCHMODAT_E] = {FILLER_DISABLED},
        [PPME_SYSCALL_FCHMODAT_X] = {FILLER_REF(sys_fchmodat_x)},
        [PPME_SYSCALL_CHMOD_E] = {FILLER_DISABLED},
        [PPME_SYSCALL_CHMOD_X] = {FILLER_REF(sys_chmod_x)},
        [PPME_SYSCALL_FCHMOD_E] = {FILLER_DISABLED},
