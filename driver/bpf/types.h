...
enum scap_map_types {
	...
	SCAP_TAIL_MAP = 1,
	SCAP_TTM_TAIL_MAP = 2,
	SCAP_IA32_TTM_TAIL_MAP = 3,
	SCAP_SYSCALL_TABLE = 4,
	SCAP_EVENT_INFO_TABLE = 5,
	SCAP_FILLERS_TABLE = 6,
	SCAP_FRAME_SCRATCH_MAP = 7,
	SCAP_TMP_SCRATCH_MAP = 8,
	SCAP_SETTINGS_MAP = 9,
	SCAP_LOCAL_STATE_MAP = 10,
	SCAP_INTERESTING_SYSCALLS_TABLE = 11,
	SCAP_IA32_64_MAP = 12,
#ifndef BPF_SUPPORTS_RAW_TRACEPOINTS
	SCAP_STASH_MAP = 13,
#endif
