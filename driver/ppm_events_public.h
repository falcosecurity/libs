 ...
 *  @{
 */
#define PPM_EVENT_FIELDS \
	PPM_EVENT_X(GENERIC_E, 0) \
	PPM_EVENT_X(GENERIC_X, 1) \
	PPM_EVENT_X(SYSCALL_OPEN_E, 2) \
	PPM_EVENT_X(SYSCALL_OPEN_X, 3) \
	PPM_EVENT_X(SYSCALL_CLOSE_E, 4) \
	PPM_EVENT_X(SYSCALL_CLOSE_X, 5) \
	PPM_EVENT_X(SYSCALL_READ_E, 6) \
	PPM_EVENT_X(SYSCALL_READ_X, 7) \
	PPM_EVENT_X(SYSCALL_WRITE_E, 8) \
	PPM_EVENT_X(SYSCALL_WRITE_X, 9) \
	PPM_EVENT_X(SYSCALL_BRK_1_E, 10) \
	PPM_EVENT_X(SYSCALL_BRK_1_X, 11) \
	PPM_EVENT_X(SYSCALL_EXECVE_8_E, 12) \
	PPM_EVENT_X(SYSCALL_EXECVE_8_X, 13) \
	PPM_EVENT_X(SYSCALL_CLONE_11_E, 14) \
	PPM_EVENT_X(SYSCALL_CLONE_11_X, 15) \
	PPM_EVENT_X(PROCEXIT_E, 16) \
	PPM_EVENT_X(PROCEXIT_X, 17) /* This should never be called */ \
	PPM_EVENT_X(SOCKET_SOCKET_E, 18) \
	PPM_EVENT_X(SOCKET_SOCKET_X, 19) \
	PPM_EVENT_X(SOCKET_BIND_E, 20) \
	PPM_EVENT_X(SOCKET_BIND_X, 21) \
	PPM_EVENT_X(SOCKET_CONNECT_E, 22) \
	PPM_EVENT_X(SOCKET_CONNECT_X, 23) \
	PPM_EVENT_X(SOCKET_LISTEN_E, 24) \
	PPM_EVENT_X(SOCKET_LISTEN_X, 25) \
	PPM_EVENT_X(SOCKET_ACCEPT_E, 26) \
	PPM_EVENT_X(SOCKET_ACCEPT_X, 27) \
	PPM_EVENT_X(SOCKET_SEND_E, 28) \
	PPM_EVENT_X(SOCKET_SEND_X, 29) \
	PPM_EVENT_X(SOCKET_SENDTO_E, 30) \
	PPM_EVENT_X(SOCKET_SENDTO_X, 31) \
	PPM_EVENT_X(SOCKET_RECV_E, 32) \
	PPM_EVENT_X(SOCKET_RECV_X, 33) \
	PPM_EVENT_X(SOCKET_RECVFROM_E, 34) \
	PPM_EVENT_X(SOCKET_RECVFROM_X, 35) \
	PPM_EVENT_X(SOCKET_SHUTDOWN_E, 36) \
	PPM_EVENT_X(SOCKET_SHUTDOWN_X, 37) \
	PPM_EVENT_X(SOCKET_GETSOCKNAME_E, 38) \
	PPM_EVENT_X(SOCKET_GETSOCKNAME_X, 39) \
	PPM_EVENT_X(SOCKET_GETPEERNAME_E, 40) \
	PPM_EVENT_X(SOCKET_GETPEERNAME_X, 41) \
	PPM_EVENT_X(SOCKET_SOCKETPAIR_E, 42) \
	PPM_EVENT_X(SOCKET_SOCKETPAIR_X, 43) \
	PPM_EVENT_X(SOCKET_SETSOCKOPT_E, 44) \
	PPM_EVENT_X(SOCKET_SETSOCKOPT_X, 45) \
	PPM_EVENT_X(SOCKET_GETSOCKOPT_E, 46) \
	PPM_EVENT_X(SOCKET_GETSOCKOPT_X, 47) \
	PPM_EVENT_X(SOCKET_SENDMSG_E, 48) \
	PPM_EVENT_X(SOCKET_SENDMSG_X, 49) \
	PPM_EVENT_X(SOCKET_SENDMMSG_E, 50) \
	PPM_EVENT_X(SOCKET_SENDMMSG_X, 51) \
	PPM_EVENT_X(SOCKET_RECVMSG_E, 52) \
	PPM_EVENT_X(SOCKET_RECVMSG_X, 53) \
	PPM_EVENT_X(SOCKET_RECVMMSG_E, 54) \
	PPM_EVENT_X(SOCKET_RECVMMSG_X, 55) \
	PPM_EVENT_X(SOCKET_ACCEPT4_E, 56) \
	PPM_EVENT_X(SOCKET_ACCEPT4_X, 57) \
	PPM_EVENT_X(SYSCALL_CREAT_E, 58) \
	PPM_EVENT_X(SYSCALL_CREAT_X, 59) \
	PPM_EVENT_X(SYSCALL_PIPE_E, 60) \
	PPM_EVENT_X(SYSCALL_PIPE_X, 61) \
	PPM_EVENT_X(SYSCALL_EVENTFD_E, 62) \
	PPM_EVENT_X(SYSCALL_EVENTFD_X, 63) \
	PPM_EVENT_X(SYSCALL_FUTEX_E, 64) \
	PPM_EVENT_X(SYSCALL_FUTEX_X, 65) \
	PPM_EVENT_X(SYSCALL_STAT_E, 66) \
	PPM_EVENT_X(SYSCALL_STAT_X, 67) \
	PPM_EVENT_X(SYSCALL_LSTAT_E, 68) \
	PPM_EVENT_X(SYSCALL_LSTAT_X, 69) \
	PPM_EVENT_X(SYSCALL_FSTAT_E, 70) \
	PPM_EVENT_X(SYSCALL_FSTAT_X, 71) \
	PPM_EVENT_X(SYSCALL_STAT64_E, 72) \
	PPM_EVENT_X(SYSCALL_STAT64_X, 73) \
	PPM_EVENT_X(SYSCALL_LSTAT64_E, 74) \
	PPM_EVENT_X(SYSCALL_LSTAT64_X, 75) \
	PPM_EVENT_X(SYSCALL_FSTAT64_E, 76) \
	PPM_EVENT_X(SYSCALL_FSTAT64_X, 77) \
	PPM_EVENT_X(SYSCALL_EPOLLWAIT_E, 78) \
	PPM_EVENT_X(SYSCALL_EPOLLWAIT_X, 79) \
	PPM_EVENT_X(SYSCALL_POLL_E, 80) \
	PPM_EVENT_X(SYSCALL_POLL_X, 81) \
	PPM_EVENT_X(SYSCALL_SELECT_E, 82) \
	PPM_EVENT_X(SYSCALL_SELECT_X, 83) \
	PPM_EVENT_X(SYSCALL_NEWSELECT_E, 84) \
	PPM_EVENT_X(SYSCALL_NEWSELECT_X, 85) \
	PPM_EVENT_X(SYSCALL_LSEEK_E, 86) \
	PPM_EVENT_X(SYSCALL_LSEEK_X, 87) \
	PPM_EVENT_X(SYSCALL_LLSEEK_E, 88) \
	PPM_EVENT_X(SYSCALL_LLSEEK_X, 89) \
	PPM_EVENT_X(SYSCALL_IOCTL_2_E, 90) \
	PPM_EVENT_X(SYSCALL_IOCTL_2_X, 91) \
	PPM_EVENT_X(SYSCALL_GETCWD_E, 92) \
	PPM_EVENT_X(SYSCALL_GETCWD_X, 93) \
	PPM_EVENT_X(SYSCALL_CHDIR_E, 94) \
	PPM_EVENT_X(SYSCALL_CHDIR_X, 95) \
	PPM_EVENT_X(SYSCALL_FCHDIR_E, 96) \
	PPM_EVENT_X(SYSCALL_FCHDIR_X, 97) \
	PPM_EVENT_X(SYSCALL_MKDIR_E, 98) /* mkdir/rmdir events are not emitted anymore */ \
	PPM_EVENT_X(SYSCALL_MKDIR_X, 99) \
	PPM_EVENT_X(SYSCALL_RMDIR_E, 100) \
	PPM_EVENT_X(SYSCALL_RMDIR_X, 101) \
	PPM_EVENT_X(SYSCALL_OPENAT_E, 102) \
	PPM_EVENT_X(SYSCALL_OPENAT_X, 103) \
	PPM_EVENT_X(SYSCALL_LINK_E, 104) \
	PPM_EVENT_X(SYSCALL_LINK_X, 105) \
	PPM_EVENT_X(SYSCALL_LINKAT_E, 106) \
	PPM_EVENT_X(SYSCALL_LINKAT_X, 107) \
	PPM_EVENT_X(SYSCALL_UNLINK_E, 108) \
	PPM_EVENT_X(SYSCALL_UNLINK_X, 109) \
	PPM_EVENT_X(SYSCALL_UNLINKAT_E, 110) \
	PPM_EVENT_X(SYSCALL_UNLINKAT_X, 111) \
	PPM_EVENT_X(SYSCALL_PREAD_E, 112) \
	PPM_EVENT_X(SYSCALL_PREAD_X, 113) \
	PPM_EVENT_X(SYSCALL_PWRITE_E, 114) \
	PPM_EVENT_X(SYSCALL_PWRITE_X, 115) \
	PPM_EVENT_X(SYSCALL_READV_E, 116) \
	PPM_EVENT_X(SYSCALL_READV_X, 117) \
	PPM_EVENT_X(SYSCALL_WRITEV_E, 118) \
	PPM_EVENT_X(SYSCALL_WRITEV_X, 119) \
	PPM_EVENT_X(SYSCALL_PREADV_E, 120) \
	PPM_EVENT_X(SYSCALL_PREADV_X, 121) \
	PPM_EVENT_X(SYSCALL_PWRITEV_E, 122) \
	PPM_EVENT_X(SYSCALL_PWRITEV_X, 123) \
	PPM_EVENT_X(SYSCALL_DUP_E, 124) \
	PPM_EVENT_X(SYSCALL_DUP_X, 125) \
	PPM_EVENT_X(SYSCALL_SIGNALFD_E, 126) \
	PPM_EVENT_X(SYSCALL_SIGNALFD_X, 127) \
	PPM_EVENT_X(SYSCALL_KILL_E, 128) \
	PPM_EVENT_X(SYSCALL_KILL_X, 129) \
	PPM_EVENT_X(SYSCALL_TKILL_E, 130) \
	PPM_EVENT_X(SYSCALL_TKILL_X, 131) \
	PPM_EVENT_X(SYSCALL_TGKILL_E, 132) \
	PPM_EVENT_X(SYSCALL_TGKILL_X, 133) \
	PPM_EVENT_X(SYSCALL_NANOSLEEP_E, 134) \
	PPM_EVENT_X(SYSCALL_NANOSLEEP_X, 135) \
	PPM_EVENT_X(SYSCALL_TIMERFD_CREATE_E, 136) \
	PPM_EVENT_X(SYSCALL_TIMERFD_CREATE_X, 137) \
	PPM_EVENT_X(SYSCALL_INOTIFY_INIT_E, 138) \
	PPM_EVENT_X(SYSCALL_INOTIFY_INIT_X, 139) \
	PPM_EVENT_X(SYSCALL_GETRLIMIT_E, 140) \
	PPM_EVENT_X(SYSCALL_GETRLIMIT_X, 141) \
	PPM_EVENT_X(SYSCALL_SETRLIMIT_E, 142) \
	PPM_EVENT_X(SYSCALL_SETRLIMIT_X, 143) \
	PPM_EVENT_X(SYSCALL_PRLIMIT_E, 144) \
	PPM_EVENT_X(SYSCALL_PRLIMIT_X, 145) \
	PPM_EVENT_X(SCHEDSWITCH_1_E, 146) \
	PPM_EVENT_X(SCHEDSWITCH_1_X, 147) /* This should never be called */ \
	PPM_EVENT_X(DROP_E, 148) /* For internal use */ \
	PPM_EVENT_X(DROP_X, 149) /* For internal use */ \
	PPM_EVENT_X(SYSCALL_FCNTL_E, 150) /* For internal use */ \
	PPM_EVENT_X(SYSCALL_FCNTL_X, 151) /* For internal use */ \
	PPM_EVENT_X(SCHEDSWITCH_6_E, 152) \
	PPM_EVENT_X(SCHEDSWITCH_6_X, 153) /* This should never be called */ \
	PPM_EVENT_X(SYSCALL_EXECVE_13_E, 154) \
	PPM_EVENT_X(SYSCALL_EXECVE_13_X, 155) \
	PPM_EVENT_X(SYSCALL_CLONE_16_E, 156) \
	PPM_EVENT_X(SYSCALL_CLONE_16_X, 157) \
	PPM_EVENT_X(SYSCALL_BRK_4_E, 158) \
	PPM_EVENT_X(SYSCALL_BRK_4_X, 159) \
	PPM_EVENT_X(SYSCALL_MMAP_E, 160) \
	PPM_EVENT_X(SYSCALL_MMAP_X, 161) \
	PPM_EVENT_X(SYSCALL_MMAP2_E, 162) \
	PPM_EVENT_X(SYSCALL_MMAP2_X, 163) \
	PPM_EVENT_X(SYSCALL_MUNMAP_E, 164) \
	PPM_EVENT_X(SYSCALL_MUNMAP_X, 165) \
	PPM_EVENT_X(SYSCALL_SPLICE_E, 166) \
	PPM_EVENT_X(SYSCALL_SPLICE_X, 167) \
	PPM_EVENT_X(SYSCALL_PTRACE_E, 168) \
	PPM_EVENT_X(SYSCALL_PTRACE_X, 169) \
	PPM_EVENT_X(SYSCALL_IOCTL_3_E, 170) \
	PPM_EVENT_X(SYSCALL_IOCTL_3_X, 171) \
	PPM_EVENT_X(SYSCALL_EXECVE_14_E, 172) \
	PPM_EVENT_X(SYSCALL_EXECVE_14_X, 173) \
	PPM_EVENT_X(SYSCALL_RENAME_E, 174) \
	PPM_EVENT_X(SYSCALL_RENAME_X, 175) \
	PPM_EVENT_X(SYSCALL_RENAMEAT_E, 176) \
	PPM_EVENT_X(SYSCALL_RENAMEAT_X, 177) \
	PPM_EVENT_X(SYSCALL_SYMLINK_E, 178) \
	PPM_EVENT_X(SYSCALL_SYMLINK_X, 179) \
	PPM_EVENT_X(SYSCALL_SYMLINKAT_E, 180) \
	PPM_EVENT_X(SYSCALL_SYMLINKAT_X, 181) \
	PPM_EVENT_X(SYSCALL_FORK_E, 182) \
	PPM_EVENT_X(SYSCALL_FORK_X, 183) \
	PPM_EVENT_X(SYSCALL_VFORK_E, 184) \
	PPM_EVENT_X(SYSCALL_VFORK_X, 185) \
	PPM_EVENT_X(PROCEXIT_1_E, 186) \
	PPM_EVENT_X(PROCEXIT_1_X, 187) /* This should never be called */ \
	PPM_EVENT_X(SYSCALL_SENDFILE_E, 188) \
	PPM_EVENT_X(SYSCALL_SENDFILE_X, 189) /* This should never be called */ \
	PPM_EVENT_X(SYSCALL_QUOTACTL_E, 190) \
	PPM_EVENT_X(SYSCALL_QUOTACTL_X, 191) \
	PPM_EVENT_X(SYSCALL_SETRESUID_E, 192) \
	PPM_EVENT_X(SYSCALL_SETRESUID_X, 193) \
	PPM_EVENT_X(SYSCALL_SETRESGID_E, 194) \
	PPM_EVENT_X(SYSCALL_SETRESGID_X, 195) \
	PPM_EVENT_X(SCAPEVENT_E, 196) \
	PPM_EVENT_X(SCAPEVENT_X, 197) /* This should never be called */ \
	PPM_EVENT_X(SYSCALL_SETUID_E, 198) \
	PPM_EVENT_X(SYSCALL_SETUID_X, 199) \
	PPM_EVENT_X(SYSCALL_SETGID_E, 200) \
	PPM_EVENT_X(SYSCALL_SETGID_X, 201) \
	PPM_EVENT_X(SYSCALL_GETUID_E, 202) \
	PPM_EVENT_X(SYSCALL_GETUID_X, 203) \
	PPM_EVENT_X(SYSCALL_GETEUID_E, 204) \
	PPM_EVENT_X(SYSCALL_GETEUID_X, 205) \
	PPM_EVENT_X(SYSCALL_GETGID_E, 206) \
	PPM_EVENT_X(SYSCALL_GETGID_X, 207) \
	PPM_EVENT_X(SYSCALL_GETEGID_E, 208) \
	PPM_EVENT_X(SYSCALL_GETEGID_X, 209) \
	PPM_EVENT_X(SYSCALL_GETRESUID_E, 210) \
	PPM_EVENT_X(SYSCALL_GETRESUID_X, 211) \
	PPM_EVENT_X(SYSCALL_GETRESGID_E, 212) \
	PPM_EVENT_X(SYSCALL_GETRESGID_X, 213) \
	PPM_EVENT_X(SYSCALL_EXECVE_15_E, 214) \
	PPM_EVENT_X(SYSCALL_EXECVE_15_X, 215) \
	PPM_EVENT_X(SYSCALL_CLONE_17_E, 216) \
	PPM_EVENT_X(SYSCALL_CLONE_17_X, 217) \
	PPM_EVENT_X(SYSCALL_FORK_17_E, 218) \
	PPM_EVENT_X(SYSCALL_FORK_17_X, 219) \
	PPM_EVENT_X(SYSCALL_VFORK_17_E, 220) \
	PPM_EVENT_X(SYSCALL_VFORK_17_X, 221) \
	PPM_EVENT_X(SYSCALL_CLONE_20_E, 222) \
	PPM_EVENT_X(SYSCALL_CLONE_20_X, 223) \
	PPM_EVENT_X(SYSCALL_FORK_20_E, 224) \
	PPM_EVENT_X(SYSCALL_FORK_20_X, 225) \
	PPM_EVENT_X(SYSCALL_VFORK_20_E, 226) \
	PPM_EVENT_X(SYSCALL_VFORK_20_X, 227) \
	PPM_EVENT_X(CONTAINER_E, 228) \
	PPM_EVENT_X(CONTAINER_X, 229) \
	PPM_EVENT_X(SYSCALL_EXECVE_16_E, 230) \
	PPM_EVENT_X(SYSCALL_EXECVE_16_X, 231) \
	PPM_EVENT_X(SIGNALDELIVER_E, 232) \
	PPM_EVENT_X(SIGNALDELIVER_X, 233) /* This should never be called */ \
	PPM_EVENT_X(PROCINFO_E, 234) \
	PPM_EVENT_X(PROCINFO_X, 235) /* This should never be called */ \
	PPM_EVENT_X(SYSCALL_GETDENTS_E, 236) \
	PPM_EVENT_X(SYSCALL_GETDENTS_X, 237) \
	PPM_EVENT_X(SYSCALL_GETDENTS64_E, 238) \
	PPM_EVENT_X(SYSCALL_GETDENTS64_X, 239) \
	PPM_EVENT_X(SYSCALL_SETNS_E, 240) \
	PPM_EVENT_X(SYSCALL_SETNS_X, 241) \
	PPM_EVENT_X(SYSCALL_FLOCK_E, 242) \
	PPM_EVENT_X(SYSCALL_FLOCK_X, 243) \
	PPM_EVENT_X(CPU_HOTPLUG_E, 244) \
	PPM_EVENT_X(CPU_HOTPLUG_X, 245) /* This should never be called */ \
	PPM_EVENT_X(SOCKET_ACCEPT_5_E, 246) \
	PPM_EVENT_X(SOCKET_ACCEPT_5_X, 247) \
	PPM_EVENT_X(SOCKET_ACCEPT4_5_E, 248) \
	PPM_EVENT_X(SOCKET_ACCEPT4_5_X, 249) \
	PPM_EVENT_X(SYSCALL_SEMOP_E, 250) \
	PPM_EVENT_X(SYSCALL_SEMOP_X, 251) \
	PPM_EVENT_X(SYSCALL_SEMCTL_E, 252) \
	PPM_EVENT_X(SYSCALL_SEMCTL_X, 253) \
	PPM_EVENT_X(SYSCALL_PPOLL_E, 254) \
	PPM_EVENT_X(SYSCALL_PPOLL_X, 255) \
	PPM_EVENT_X(SYSCALL_MOUNT_E, 256) \
	PPM_EVENT_X(SYSCALL_MOUNT_X, 257) \
	PPM_EVENT_X(SYSCALL_UMOUNT_E, 258) \
	PPM_EVENT_X(SYSCALL_UMOUNT_X, 259) \
	PPM_EVENT_X(K8S_E, 260) \
	PPM_EVENT_X(K8S_X, 261) \
	PPM_EVENT_X(SYSCALL_SEMGET_E, 262) \
	PPM_EVENT_X(SYSCALL_SEMGET_X, 263) \
	PPM_EVENT_X(SYSCALL_ACCESS_E, 264) \
	PPM_EVENT_X(SYSCALL_ACCESS_X, 265) \
	PPM_EVENT_X(SYSCALL_CHROOT_E, 266) \
	PPM_EVENT_X(SYSCALL_CHROOT_X, 267) \
	PPM_EVENT_X(TRACER_E, 268) \
	PPM_EVENT_X(TRACER_X, 269) \
	PPM_EVENT_X(MESOS_E, 270) \
	PPM_EVENT_X(MESOS_X, 271) \
	PPM_EVENT_X(CONTAINER_JSON_E, 272) \
	PPM_EVENT_X(CONTAINER_JSON_X, 273) \
	PPM_EVENT_X(SYSCALL_SETSID_E, 274) \
	PPM_EVENT_X(SYSCALL_SETSID_X, 275) \
	PPM_EVENT_X(SYSCALL_MKDIR_2_E, 276) \
	PPM_EVENT_X(SYSCALL_MKDIR_2_X, 277) \
	PPM_EVENT_X(SYSCALL_RMDIR_2_E, 278) \
	PPM_EVENT_X(SYSCALL_RMDIR_2_X, 279) \
	PPM_EVENT_X(NOTIFICATION_E, 280) \
	PPM_EVENT_X(NOTIFICATION_X, 281) \
	PPM_EVENT_X(SYSCALL_EXECVE_17_E, 282) \
	PPM_EVENT_X(SYSCALL_EXECVE_17_X, 283) \
	PPM_EVENT_X(SYSCALL_UNSHARE_E, 284) \
	PPM_EVENT_X(SYSCALL_UNSHARE_X, 285) \
	PPM_EVENT_X(INFRASTRUCTURE_EVENT_E, 286) \
	PPM_EVENT_X(INFRASTRUCTURE_EVENT_X, 287) \
	PPM_EVENT_X(SYSCALL_EXECVE_18_E, 288) \
	PPM_EVENT_X(SYSCALL_EXECVE_18_X, 289) \
	PPM_EVENT_X(PAGE_FAULT_E, 290) \
	PPM_EVENT_X(PAGE_FAULT_X, 291) \
	PPM_EVENT_X(SYSCALL_EXECVE_19_E, 292) \
	PPM_EVENT_X(SYSCALL_EXECVE_19_X, 293) \
	PPM_EVENT_X(SYSCALL_SETPGID_E, 294) \
	PPM_EVENT_X(SYSCALL_SETPGID_X, 295) \
	PPM_EVENT_X(SYSCALL_BPF_E, 296) \
	PPM_EVENT_X(SYSCALL_BPF_X, 297) \
	PPM_EVENT_X(SYSCALL_SECCOMP_E, 298) \
	PPM_EVENT_X(SYSCALL_SECCOMP_X, 299) \
	PPM_EVENT_X(SYSCALL_UNLINK_2_E, 300) \
	PPM_EVENT_X(SYSCALL_UNLINK_2_X, 301) \
	PPM_EVENT_X(SYSCALL_UNLINKAT_2_E, 302) \
	PPM_EVENT_X(SYSCALL_UNLINKAT_2_X, 303) \
	PPM_EVENT_X(SYSCALL_MKDIRAT_E, 304) \
	PPM_EVENT_X(SYSCALL_MKDIRAT_X, 305) \
	PPM_EVENT_X(SYSCALL_OPENAT_2_E, 306) \
	PPM_EVENT_X(SYSCALL_OPENAT_2_X, 307) \
	PPM_EVENT_X(SYSCALL_LINK_2_E, 308) \
	PPM_EVENT_X(SYSCALL_LINK_2_X, 309) \
	PPM_EVENT_X(SYSCALL_LINKAT_2_E, 310) \
	PPM_EVENT_X(SYSCALL_LINKAT_2_X, 311) \
	PPM_EVENT_X(SYSCALL_FCHMODAT_E, 312) \
	PPM_EVENT_X(SYSCALL_FCHMODAT_X, 313) \
	PPM_EVENT_X(SYSCALL_CHMOD_E, 314) \
	PPM_EVENT_X(SYSCALL_CHMOD_X, 315) \
	PPM_EVENT_X(SYSCALL_FCHMOD_E, 316) \
	PPM_EVENT_X(SYSCALL_FCHMOD_X, 317) \
	PPM_EVENT_X(SYSCALL_RENAMEAT2_E, 318) \
	PPM_EVENT_X(SYSCALL_RENAMEAT2_X, 319) \
	PPM_EVENT_X(SYSCALL_USERFAULTFD_E, 320) \
	PPM_EVENT_X(SYSCALL_USERFAULTFD_X, 321) \
	PPM_EVENT_X(PLUGINEVENT_E, 322) \
	PPM_EVENT_X(PLUGINEVENT_X, 323) \
	PPM_EVENT_X(CONTAINER_JSON_2_E, 324) \
	PPM_EVENT_X(CONTAINER_JSON_2_X, 325) \
	PPM_EVENT_X(SYSCALL_OPENAT2_E, 326) \
	PPM_EVENT_X(SYSCALL_OPENAT2_X, 327) \
	PPM_EVENT_X(SYSCALL_MPROTECT_E, 328) \
	PPM_EVENT_X(SYSCALL_MPROTECT_X, 329) \
	PPM_EVENT_X(SYSCALL_EXECVEAT_E, 330) \
	PPM_EVENT_X(SYSCALL_EXECVEAT_X, 331) \
	PPM_EVENT_X(SYSCALL_COPY_FILE_RANGE_E, 332) \
	PPM_EVENT_X(SYSCALL_COPY_FILE_RANGE_X, 333) \
	PPM_EVENT_X(SYSCALL_CLONE3_E, 334) \
	PPM_EVENT_X(SYSCALL_CLONE3_X, 335) \
	PPM_EVENT_X(SYSCALL_OPEN_BY_HANDLE_AT_E, 336) \
	PPM_EVENT_X(SYSCALL_OPEN_BY_HANDLE_AT_X, 337) \
	PPM_EVENT_X(SYSCALL_IO_URING_SETUP_E, 338) \
	PPM_EVENT_X(SYSCALL_IO_URING_SETUP_X, 339) \
	PPM_EVENT_X(SYSCALL_IO_URING_ENTER_E, 340) \
	PPM_EVENT_X(SYSCALL_IO_URING_ENTER_X, 341) \
	PPM_EVENT_X(SYSCALL_IO_URING_REGISTER_E, 342) \
	PPM_EVENT_X(SYSCALL_IO_URING_REGISTER_X, 343) \
	PPM_EVENT_X(SYSCALL_MLOCK_E, 344) \
	PPM_EVENT_X(SYSCALL_MLOCK_X, 345) \
	PPM_EVENT_X(SYSCALL_MUNLOCK_E, 346) \
	PPM_EVENT_X(SYSCALL_MUNLOCK_X, 347) \
	PPM_EVENT_X(SYSCALL_MLOCKALL_E, 348) \
	PPM_EVENT_X(SYSCALL_MLOCKALL_X, 349) \
	PPM_EVENT_X(SYSCALL_MUNLOCKALL_E, 350) \
	PPM_EVENT_X(SYSCALL_MUNLOCKALL_X, 351) \
	PPM_EVENT_X(SYSCALL_CAPSET_E, 352) \
	PPM_EVENT_X(SYSCALL_CAPSET_X, 353) \
	PPM_EVENT_X(USER_ADDED_E, 354) \
	PPM_EVENT_X(USER_ADDED_X, 355) \
	PPM_EVENT_X(USER_DELETED_E, 356) \
	PPM_EVENT_X(USER_DELETED_X, 357) \
	PPM_EVENT_X(GROUP_ADDED_E, 358) \
	PPM_EVENT_X(GROUP_ADDED_X, 359) \
	PPM_EVENT_X(GROUP_DELETED_E, 360) \
	PPM_EVENT_X(GROUP_DELETED_X, 361) \
	PPM_EVENT_X(SYSCALL_DUP2_E, 362) \
	PPM_EVENT_X(SYSCALL_DUP2_X, 363) \
	PPM_EVENT_X(SYSCALL_DUP3_E, 364) \
	PPM_EVENT_X(SYSCALL_DUP3_X, 365) \
	PPM_EVENT_X(SYSCALL_DUP_1_E, 366) \
	PPM_EVENT_X(SYSCALL_DUP_1_X, 367) \
	PPM_EVENT_X(SYSCALL_BPF_2_E, 368) \
	PPM_EVENT_X(SYSCALL_BPF_2_X, 369) \
	PPM_EVENT_X(SYSCALL_MLOCK2_E, 370) \
	PPM_EVENT_X(SYSCALL_MLOCK2_X, 371) \
	PPM_EVENT_X(SYSCALL_FSCONFIG_E, 372) \
	PPM_EVENT_X(SYSCALL_FSCONFIG_X, 373) \
	PPM_EVENT_X(SYSCALL_EPOLL_CREATE_E, 374) \
	PPM_EVENT_X(SYSCALL_EPOLL_CREATE_X, 375) \
	PPM_EVENT_X(SYSCALL_EPOLL_CREATE1_E, 376) \
	PPM_EVENT_X(SYSCALL_EPOLL_CREATE1_X, 377) \
	PPM_EVENT_X(SYSCALL_CHOWN_E, 378) \
	PPM_EVENT_X(SYSCALL_CHOWN_X, 379) \
	PPM_EVENT_X(SYSCALL_LCHOWN_E, 380) \
	PPM_EVENT_X(SYSCALL_LCHOWN_X, 381) \
	PPM_EVENT_X(SYSCALL_FCHOWN_E, 382) \
	PPM_EVENT_X(SYSCALL_FCHOWN_X, 383) \
	PPM_EVENT_X(SYSCALL_FCHOWNAT_E, 384) \
	PPM_EVENT_X(SYSCALL_FCHOWNAT_X, 385) \
	PPM_EVENT_X(SYSCALL_UMOUNT_1_E, 386) \
	PPM_EVENT_X(SYSCALL_UMOUNT_1_X, 387) \
	PPM_EVENT_X(SOCKET_ACCEPT4_6_E, 388) \
	PPM_EVENT_X(SOCKET_ACCEPT4_6_X, 389) \
	PPM_EVENT_X(SYSCALL_UMOUNT2_E, 390) \
	PPM_EVENT_X(SYSCALL_UMOUNT2_X, 391) \
	PPM_EVENT_X(SYSCALL_PIPE2_E, 392) \
	PPM_EVENT_X(SYSCALL_PIPE2_X, 393) \
	PPM_EVENT_X(SYSCALL_INOTIFY_INIT1_E, 394) \
	PPM_EVENT_X(SYSCALL_INOTIFY_INIT1_X, 395) \
	PPM_EVENT_X(SYSCALL_EVENTFD2_E, 396) \
	PPM_EVENT_X(SYSCALL_EVENTFD2_X, 397) \
	PPM_EVENT_X(SYSCALL_SIGNALFD4_E, 398) \
	PPM_EVENT_X(SYSCALL_SIGNALFD4_X, 399) \
	PPM_EVENT_X(SYSCALL_PRCTL_E, 400) \
	PPM_EVENT_X(SYSCALL_PRCTL_X, 401) \
	PPM_EVENT_X(ASYNCEVENT_E, 402) \
	PPM_EVENT_X(ASYNCEVENT_X, 403) \
	PPM_EVENT_X(SYSCALL_MEMFD_CREATE_E, 404) \
	PPM_EVENT_X(SYSCALL_MEMFD_CREATE_X, 405) \
	PPM_EVENT_X(SYSCALL_PIDFD_GETFD_E, 406) \
	PPM_EVENT_X(SYSCALL_PIDFD_GETFD_X, 407) 

typedef enum {
#define PPM_EVENT_X(name, value) PPME_##name = (value),
	PPM_EVENT_FIELDS
#undef PPM_EVENT_X
	PPM_EVENT_MAX,
} ppm_event_code;
