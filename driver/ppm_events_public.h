...
#define PPM_SC_FIELDS \
	...
	PPM_SC_X(SCHED_GETATTR, 382) \
	PPM_SC_X(FACCESSAT2, 383) \
	PPM_SC_X(_SYSCTL, 384) \
	PPM_SC_X(QUERY_MODULE, 385) \
	PPM_SC_X(GET_MEMPOLICY, 386) \
	PPM_SC_X(SYNC_FILE_RANGE, 387) \
	PPM_SC_X(PROCESS_MADVISE, 388) \
...
#define PPM_SC_TP_FIELDS \
	PPM_SC_TP_X(SCHED_PROCESS_EXIT, PPM_SC_TP_START+0) \
	PPM_SC_TP_X(SCHED_SWITCH, PPM_SC_TP_START+1) \
	PPM_SC_TP_X(PAGE_FAULT_USER, PPM_SC_TP_START+2) \
	PPM_SC_TP_X(PAGE_FAULT_KERNEL, PPM_SC_TP_START+3) \
	PPM_SC_TP_X(SIGNAL_DELIVER, PPM_SC_TP_START+4) \
