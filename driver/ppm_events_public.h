...
enum ppm_event_category {
	...
	EC_INTERNAL = (1 << 8),	/* Internal event that shouldn't be shown to the user */
	...
	EC_GENERICAL = (1 << 12),	/* Event not generated by a source but used for notifications or enrichment */
	EC_NOT_GENERATED = (1 << 13),	/* Event not generated at all, we create them just to fill the pair ENTER/EXIT */
};
