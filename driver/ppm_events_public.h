...
enum ppm_event_category
{
	...
	EC_OTHER = (1 << 0),	   /* No specific category */
	EC_FILE = (1 << 1),	   /* File operation (open, close...) or file I/O */
	EC_NET = (1 << 2),	   /* Network operation (socket, bind...) or network I/O */
	EC_IPC = (1 << 3),	   /* IPC operation (pipe, futex...) or IPC I/O (e.g. on a pipe) */
	EC_MEMORY = (1 << 4),	   /* Memory-related operation (e.g. brk) */
	EC_PROCESS = (1 << 5),	   /* Process-related operation (fork, clone...) */
	EC_SLEEP = (1 << 6),	   /* Plain sleep */
	EC_SYSTEM = (1 << 7),	   /* System-related operations (e.g. reboot) */
	EC_SIGNAL = (1 << 8),	   /* Signal-related operations (e.g. signal) */
	EC_USER = (1 << 9),	   /* User-related operations (e.g. getuid) */
	EC_TIME = (1 << 10),	   /* Time-related syscalls (e.g. gettimeofday) */
	EC_PROCESSING = (1 << 11), /* User level processing. Never used for system calls */
	EC_IO_READ = (1 << 12),	   /* General I/O read (can be file, socket, IPC...) */
	EC_IO_WRITE = (1 << 13),   /* General I/O write (can be file, socket, IPC...) */
	EC_IO_OTHER = (1 << 14),   /* General I/O that is neither read not write (can be file, socket, IPC...) */
	EC_WAIT = (1 << 15),	   /* General wait (can be file, socket, IPC...) */
	EC_SCHEDULER = (1 << 16),  /* Scheduler event (e.g. context switch) */
	EC_INTERNAL = (1 << 17),   /* Internal event generated by the libraries and not by drivers */
	EC_SYSCALL = (1 << 18),	   /* Event generated by a syscall */
	EC_TRACEPOINT = (1 << 19), /* Event generated by a tracepoint */
	EC_PLUGIN = (1 << 20),	   /* Event generated by a plugin */
};
