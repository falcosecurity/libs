...
# FindTBB.cmake - Find TBB (Threading Building Blocks) library This module provides a fallback when
# TBBConfig.cmake is not available
#
# This module defines the following variables: TBB_FOUND        - True if TBB was found
# TBB_INCLUDE_DIRS - TBB include directories TBB_LIBRARIES    - TBB libraries TBB_VERSION      - TBB
# version (if available)
#
# This module also creates the following imported targets: TBB::tbb         - Main TBB library
# target
...
if(TBB_INCLUDE_DIR)
	...
	if(EXISTS "${TBB_INCLUDE_DIR}/tbb/tbb_stddef.h")
		file(STRINGS "${TBB_INCLUDE_DIR}/tbb/tbb_stddef.h" TBB_VERSION_MAJOR_LINE
			 REGEX "^#define TBB_VERSION_MAJOR"
		)
		file(STRINGS "${TBB_INCLUDE_DIR}/tbb/tbb_stddef.h" TBB_VERSION_MINOR_LINE
...
if(TBB_FOUND)
	...
	if(NOT TARGET TBB::tbb)
		...
		set_target_properties(
			TBB::tbb PROPERTIES IMPORTED_LOCATION "${TBB_LIBRARY}" INTERFACE_INCLUDE_DIRECTORIES
																   "${TBB_INCLUDE_DIR}"
		)
		...
		if(TBB_VERSION VERSION_GREATER_EQUAL "2021.0")
			set_target_properties(
				TBB::tbb PROPERTIES INTERFACE_COMPILE_DEFINITIONS "TBB_USE_GLIBCXX_VERSION=201703L"
			)
		endif()
	endif()
