...
elseif(NOT USE_BUNDLED_TBB)
	...
	if(NOT TARGET tbb)
		...
		if(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86_64")
			check_cxx_compiler_flag("-mrtm" TBB_HAS_MRTM_FLAG)
			if(TBB_HAS_MRTM_FLAG)
				set(TBB_FLAGS "${TBB_FLAGS} -mrtm")
			endif()
			check_cxx_compiler_flag("-mwaitpkg" TBB_HAS_MWAITPKG_FLAG)
			if(TBB_HAS_MWAITPKG_FLAG)
				set(TBB_FLAGS "${TBB_FLAGS} -mwaitpkg")
			endif()
		endif()
		if(EMSCRIPTEN)
