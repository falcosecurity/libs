...
elseif(NOT USE_BUNDLED_OPENSSL)
	...
	if(NOT TARGET openssl)
		...
		install(FILES "${OPENSSL_LIBRARY_SSL}" DESTINATION "./lib/${LIBS_PACKAGE_NAME}/")
		install(FILES "${OPENSSL_LIBRARY_CRYPTO}" DESTINATION "./lib/${LIBS_PACKAGE_NAME}/")
		install(DIRECTORY "${OPENSSL_INCLUDE_DIR}" DESTINATION "./include/${LIBS_PACKAGE_NAME}/")
	endif()
endif()
