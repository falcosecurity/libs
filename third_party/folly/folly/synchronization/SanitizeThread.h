...
FOLLY_ALWAYS_INLINE static void annotate_rwlock_create(void const volatile* const addr,
                                                       char const* const f,
                                                       int const l) {
...
FOLLY_ALWAYS_INLINE static void annotate_rwlock_create_static(void const volatile* const addr,
                                                              char const* const f,
                                                              int const l) {
...
FOLLY_ALWAYS_INLINE static void annotate_rwlock_destroy(void const volatile* const addr,
                                                        char const* const f,
                                                        int const l) {
...
FOLLY_ALWAYS_INLINE static void annotate_rwlock_acquired(void const volatile* const addr,
...
FOLLY_ALWAYS_INLINE static void annotate_rwlock_try_acquired(void const volatile* const addr,
                                                             annotate_rwlock_level const w,
                                                             bool const result,
                                                             char const* const f,
                                                             int const l) {
...
FOLLY_ALWAYS_INLINE static void annotate_rwlock_released(void const volatile* const addr,
                                                         annotate_rwlock_level const w,
                                                         char const* const f,
                                                         int const l) {
...
FOLLY_ALWAYS_INLINE static void annotate_benign_race_sized(void const volatile* const addr,
                                                           long const size,
...
FOLLY_ALWAYS_INLINE static void annotate_ignore_reads_begin(char const* const f, int const l) {
	auto fun = detail::annotate_ignore_reads_begin_v;
	return kIsSanitizeThread && fun ? fun(f, l) : void();
}

FOLLY_ALWAYS_INLINE static void annotate_ignore_reads_end(char const* const f, int const l) {
	auto fun = detail::annotate_ignore_reads_end_v;
	return kIsSanitizeThread && fun ? fun(f, l) : void();
}

FOLLY_ALWAYS_INLINE static void annotate_ignore_writes_begin(char const* const f, int const l) {
	auto fun = detail::annotate_ignore_writes_begin_v;
	return kIsSanitizeThread && fun ? fun(f, l) : void();
}

FOLLY_ALWAYS_INLINE static void annotate_ignore_writes_end(char const* const f, int const l) {
	auto fun = detail::annotate_ignore_writes_end_v;
	return kIsSanitizeThread && fun ? fun(f, l) : void();
}

FOLLY_ALWAYS_INLINE static void annotate_ignore_sync_begin(char const* const f, int const l) {
	auto fun = detail::annotate_ignore_sync_begin_v;
	return kIsSanitizeThread && fun ? fun(f, l) : void();
}

FOLLY_ALWAYS_INLINE static void annotate_ignore_sync_end(char const* const f, int const l) {
...
public:
	annotate_ignore_thread_sanitizer_guard(char const* const file, int const line) noexcept:
	        file_{file},
	        line_{line} {
	...
	annotate_ignore_thread_sanitizer_guard(const annotate_ignore_thread_sanitizer_guard&) = delete;
