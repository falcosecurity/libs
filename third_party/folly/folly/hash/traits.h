...
using is_hashable = std::integral_constant<bool, is_hasher_usable_v<T, Hasher<T>>>;
...
using enable_hasher_helper = detail::enable_hasher_helper_impl<
        T,
        std::enable_if_t<StrictConjunction<is_hashable<Dependencies, Hasher>...>::value>>;
...
using enable_std_hash_helper = enable_hasher_helper<T, std::hash, Dependencies...>;
