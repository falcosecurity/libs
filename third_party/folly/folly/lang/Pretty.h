...
static constexpr char* pretty_carray_copy(char* dest, const char* src, std::size_t n) {
...
template<std::size_t S>
static constexpr std::size_t pretty_lfind(char const (&haystack)[S], char const needle) {
...
template<std::size_t S>
static constexpr std::size_t pretty_rfind(char const (&haystack)[S], char const needle) {
...
template<std::size_t S>
static constexpr pretty_info pretty_parse(pretty_tag_msc, char const (&name)[S]) {
...
template<std::size_t S>
static constexpr pretty_info pretty_parse(pretty_tag_gcc, char const (&name)[S]) {
