...
alignas(kIsMobile ? sizeof(size_t) : hardware_constructive_interference_size)
        ...
        to_ascii_array<Base, Alphabet>::data = to_ascii_array<Base, Alphabet>::data_();
...
alignas(hardware_constructive_interference_size)
        ...
        to_ascii_table<Base, Alphabet>::data = to_ascii_table<Base, Alphabet>::data_();
...
struct to_ascii_powers {
	static constexpr size_t size_(Int v) { return 1 + (v < Base ? 0 : size_(v / Base)); }
...
template<uint64_t Base, typename Int>
alignas(hardware_constructive_interference_size)
        typename to_ascii_powers<Base, Int>::data_type_ const to_ascii_powers<Base, Int>::data =
                to_ascii_powers<Base, Int>::data_();

extern template to_ascii_powers<8, uint64_t>::data_type_ const to_ascii_powers<8, uint64_t>::data;
extern template to_ascii_powers<10, uint64_t>::data_type_ const to_ascii_powers<10, uint64_t>::data;
extern template to_ascii_powers<16, uint64_t>::data_type_ const to_ascii_powers<16, uint64_t>::data;
...
//  the size is known.
template<uint64_t Base, typename Alphabet>
FOLLY_ALWAYS_INLINE void to_ascii_with_basic(char* out, size_t size, uint64_t v) {
...
template<uint64_t Base, typename Alphabet>
FOLLY_ALWAYS_INLINE void to_ascii_with_array(char* out, size_t size, uint64_t v) {
...
template<uint64_t Base, typename Alphabet>
FOLLY_ALWAYS_INLINE void to_ascii_with_table(char* out, size_t size, uint64_t v) {
...
// with 0s.
template<uint64_t Base, typename Alphabet>
FOLLY_ALWAYS_INLINE void to_ascii_with_route(char* outb, size_t size, uint64_t v) {
	kIsMobile  //
	        ? to_ascii_with_array<Base, Alphabet>(outb, size, v)
	        : to_ascii_with_table<Base, Alphabet>(outb, size, v);
}
template<uint64_t Base, typename Alphabet>
FOLLY_ALWAYS_INLINE size_t to_ascii_with_route(char* outb, char const* oute, uint64_t v) {
	auto const size = to_ascii_size_route<Base>(v);
