...
constexpr auto op_new_builtin_ = FOLLY_HAS_BUILTIN(__builtin_operator_new) >= 201802L;
constexpr auto op_del_builtin_ = FOLLY_HAS_BUILTIN(__builtin_operator_del) >= 201802L;
...
FOLLY_ERASE void do_op_del_sized_(void* const p, std::size_t const s, A const... a) {
