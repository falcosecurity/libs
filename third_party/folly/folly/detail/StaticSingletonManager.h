...
private:
	...
	struct Arg {
		...
		/* implicit */ constexpr Arg(tag_t<T, Tag>) noexcept: instance{instance_<T, Tag>} {}
	};
...
using StaticSingletonManager = std::
        conditional_t<kHasRtti, StaticSingletonManagerWithRtti, StaticSingletonManagerSansRtti>;
