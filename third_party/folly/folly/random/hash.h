...
public:
	...
	using result_type = decltype(call(std::declval<Hash&>(), std::declval<state_type>()));
	...
	hash_counter_engine(Hash const& hash, state_type state) noexcept: Hash{hash}, state_{state} {}
