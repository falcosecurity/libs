...
public:
	explicit reentrant_allocator_base(reentrant_allocator_options const& options) noexcept;
	reentrant_allocator_base(reentrant_allocator_base const& that) noexcept;
	reentrant_allocator_base& operator=(reentrant_allocator_base const& that) noexcept;
	...
	friend bool operator==(reentrant_allocator_base const& a,
...
public:
	...
	FOLLY_ERASE /* implicit */ reentrant_allocator(reentrant_allocator<U> const& that) noexcept:
	        base{that} {}
	...
	friend bool operator==(reentrant_allocator<A> const& a,
...
template<typename A, typename B>
FOLLY_ERASE bool operator==(reentrant_allocator<A> const& a,
                            reentrant_allocator<B> const& b) noexcept {
	using base = detail::reentrant_allocator_base;
